<div class="room-price-by-date-<?= $timestamp ?>">
    <div class="row">
        <hr/>
                ...
                <div class="controls">
                    ...
                    <div class="col-md-8 col-sm-8 col-xs-12">
                        <div class="input-prepend input-group">
                            ...
                            <input type="text" name="room['<?= $timestamp ?>'][price_rooms][0][date]" required="required"
        ...
        <div class="col-sm-5 col-xs-4">
            <?php
            echo $this->Form->control("room.'{$timestamp}'.price_rooms.0.price", [
                'templates' => [
        ...
        <div class="col-sm-1 col-xs-1 text-right">
            <a href="#" onclick="deleteItem(this, '.room-price-by-date-<?= $timestamp ?>');" class="mt10">
