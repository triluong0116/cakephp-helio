                        ...
                        <div class="row">
                            <div class="col-sm-36">
                                <div class="mt20 pb30 text-center">
                                    <span class="semi-bold fs24 box-underline-center pb05"><?= $cate->name ?></span>
                                </div>
                                <div class="p15">
                                    <?php foreach ($cate->reviews as $key => $review) : ?>
                                     <?php if ($key < 6) : ?>
                                        <?php if ($key == 0 || $key % 3 == 0) : ?>
                                            <div class="row row-eq-height">
                                        <?php endif; ?>
                                        <?php if ($key == 5): ?>
                                            <div class="col-sm-12 mb15 pointer pc"  onclick="location.href = '<?= \Cake\Routing\Router::url(['_name' => 'review.viewall', 'slug' => $cate->slug, 'location' => $currentLocation->id]) ?>'">
                                                <div class="wrap review-item border-bottom-blue">
                                                    <div class="inner text-center">
                                                        <a class="main-color"
                                                           href="<?= \Cake\Routing\Router::url(['_name' => 'review.viewall', 'slug' => $cate->slug, 'location' => $currentLocation->id]) ?>">
                                            ...
                                            <div class="col-sm-12 mb15 pointer sp"  onclick="location.href = '<?= \Cake\Routing\Router::url(['_name' => 'review.viewall', 'slug' => $cate->slug, 'location' => $currentLocation->id]) ?>'">
                                                <div class="wrap review-item border-bottom-blue">
                                                    <div class="inner text-center mt70 mb90">
                                                        <a class="main-color" href="<?= \Cake\Routing\Router::url(['_name' => 'review.viewall', 'slug' => $cate->slug, 'location' => $currentLocation->id]) ?>">
                                                            <span class="text-center fs60"><i class="fas fa-plus-circle"></i></span>
                                                            <p>Xem tất cả</p>
                                                        </a>
                                                    </div>
                                                ...
                                                <div class="review-item border-bottom-blue">
                                                    <div class="wrap-content rectangle-image-v2">
                                                        ...
                                                        <div class="top-left text-white">
                                                            <p class="fs14">
                                                                <i class="fas fa-map-marker-alt text-pink fs16"></i>
                                                        ...
                                                        <div class="pl05 pr05">
                                                            <div class="row fs13">
                                                                <div class="col-sm-36 col-xs-36 no-pad-right">
                                                                    ...
                                                                    <p class="sp "><span class="fs17 text-orange"><?= number_format($review->price_start) . " - " . number_format($review->price_end) ?> </span>                                         </span>
                                                                        <sup class="text-black fs12">đ</sup></p>
                                                                </div>
                                                            </div>
                                                        </div>
                                        ...
                                        <?php endif; ?>
                                        <?php if (($key % 3 == 2) || $key == (count($cate->reviews) - 1)) : ?>
                                            </div>
                                        <?php endif ?>
                                    <?php endif ?>
                                    <?php endforeach; ?>
