    ...
    <div class="container mt30">
        <div class="row">
            ...
            <div class="col-sm-27">
                ...
                <?php foreach ($listreviews as $cate) : ?>
                        ...
                        <div class="col-sm-36">
                            ...
                            <div class="p15">
                                ...
                                <div class="row row-eq-height">
                                    <?php endif; ?>
                                    <?php if ($key == 5): ?>
                                    <div class="col-sm-12 mb15 pointer pc" onclick="">
                                        <div class="wrap review-item border-bottom-blue">
                                            <div class="inner text-center">
                                                <a class="main-color"
                                                   href="<?= \Cake\Routing\Router::url(['_name' => 'review.viewall', 'slug' => $cate->slug]) ?>">
                                    ...
                                    <div class="col-sm-12 mb15 pointer sp" onclick="">
                                        <div class="wrap review-item border-bottom-blue">
                                            <div class="inner text-center mt70 mb90">
                                                <a class="main-color" href="<?= \Cake\Routing\Router::url(['_name' => 'review.viewall', 'slug' => $cate->slug]) ?>">
                                                    <span class="text-center fs60"><i class="fas fa-plus-circle"></i></span>
                                                    <p>Xem tất cả</p>
                                                </a>
                                            </div>
