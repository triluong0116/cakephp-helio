                    ...
                    <div class="row mt10">
                        <div class="col-sm-18">
                            <div class="form-group">
                                ...
                                <input class="form-control popup-voucher inputmask-number" value="<?= isset($data['numVoucher']) ? $data['numVoucher'] : 0 ?>" placeholder="Số Voucher" name="amount">
                                <p id="error_amount" class="error-messages"></p>
                            </div>
                        </div>
                        <div class="col-sm-18">
                            <span class="text-super-dark fs14">Ngày Check in *</span>
                            <div class='input-group date datepicker mt15'>
                                            <span class="input-group-addon">
                                                <span class="far fa-calendar-alt main-color"></span>
                                            </span>
                                <input type='text' name="start_date" class="form-control popup-voucher"
                                       value="<?= isset($data['fromDate']) ? $data['fromDate'] : date('d-m-Y') ?>"/>
                            </div>
            ...
            <?php if ($this->request->getSession()->read('Auth.User.role_id') == 3 && $this->request->getSession()->read('Auth.User.is_active') == 1): ?>
                <div class="container">
                    ...
                    <div class="row mt20">
                        ...
                        <div class="col-sm-9">
                            <button type="button" class="btn btn-request-booking btn-block semi-bold text-white full-height" id="requestVoucherBooking">
