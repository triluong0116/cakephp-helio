                        ...
                        <div class="col-sm-36">
                            ...
                            <div class="p15">                                
                                ...
                                <?php foreach ($combos as $indexCombo => $combo): ?>
                                    <?php if ($indexCombo % 3 == 0): ?>
                                        <div class="row row-eq-height">
                                        <?php endif; ?>
                                        <?php if ($countCombos > 8 && $indexCombo == (count($combos) - 1)): ?>
                                            <div class="col-sm-12 mb15 pointer pc" onclick="location.href = '<?= \Cake\Routing\Router::url(['_name' => 'location.combo', 'slug' => $location->slug]) ?>'">             
                                                <div class="wrap combo-item border-bottom-blue">
                                                    <div class="inner text-center">
                                                        <a class="main-color pt50" href="<?= \Cake\Routing\Router::url(['_name' => 'location.combo', 'slug' => $location->slug]) ?>">
                                                            <span class="fs60"><i class="fas fa-plus-circle"></i></span>
                                                            <p>Xem tất cả Combo</p>
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-12 mb15 pointer sp" onclick="location.href = '<?= \Cake\Routing\Router::url(['_name' => 'location.combo', 'slug' => $location->slug]) ?>'">             
                                                <div class="wrap combo-item border-bottom-blue">
                                        ...
                                        <?php if ($indexCombo % 3 == 2 || $indexCombo == (count($combos) - 1)): ?>
                                        </div>                                  
                                    <?php endif; ?>
                                <?php endforeach; ?>
                                            ...
                                            <div class="col-sm-12 mb15">
                                                <div class="combo-item border-bottom-blue">
                                                    <div class="wrap-content rectangle-image-v2">
                                                        ...
                                                        <div class="top-left text-white">
                                                            <p><i class="fas fa-map-marker-alt text-pink fs16"></i>&nbsp;&nbsp;<?= $hotel->location->name ?></p>
                                                        </div>
                                                        <div class="middle-button">
                                                            <div class="button-text text-center ">
                                                    ...
                                                    <div class="combo-detail overhidden pb10">
                                                        ...
                                                        <div class="row">
                                                            <div class="pl05 pr05">
                                                                ...
                                                                <div class="col-sm-19 col-xs-19 no-pad-left text-right">
                                                                    <span class="fs12 text-grey"><strong class="text-orange"><?= number_format($hotel->totalPrice) ?></strong> đ/phòng</span>        
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="combo-detail overhidden pb10">
                                                        ...
                                                        <div class="row">
                                                            <div class="pr05 pl05">
                                                                ...
                                                                <div class="col-sm-18 col-xs-18 no-pad-left text-right">
                                                                    <span class="fs12 text-grey"><strong class="text-orange"><?= number_format(($landTour->totalPrice * (100 - $landTour->promote)) / 100) ?></strong> đ/khách</span>
                                                                    <span><p><del><?= number_format($landTour->customer_price) ?> đ</del></p></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
