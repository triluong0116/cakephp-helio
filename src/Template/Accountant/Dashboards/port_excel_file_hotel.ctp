        ...
        <div class="x_content">
            ...
            <form id="choose_date">
                <div class="control-group">
                    ...
                    <div class="row">
                        <div class="controls">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Chọn khách sạn</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="input-prepend input-group">
                                    <select name="hotel_id" class="form-control select2 w100">
            ...
            <div class="form-group">
                <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                    <a onclick="exportAccountantHotelFile(this)" class="btn btn-success" id="blog-submit">
