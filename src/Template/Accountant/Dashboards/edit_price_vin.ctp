...
<div class="form-horizontal form-label-left">
    ...
    <button type="submit" class="btn btn-primary btn-log" id="saveBooking"
            data-ctl="dashboards" data-role="accountant" data-title="3"
            data-id="<?= $vinBooking->id ?>" data-code="<?= $vinBooking->code ?>">Lưu</button>
    <?= $this->Form->end() ?>
</div>
