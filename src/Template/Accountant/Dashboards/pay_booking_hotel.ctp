                                ...
                                <tr>
                                    ...
                                    <td class="actions">
                                        ...
                                        <?php if ($booking->status < 3): ?>
                                            <?php if ($booking->payment && $booking->payment->images): ?>
                                                <button type="button" onclick="commitBooking(this, <?= $booking->id ?>, 1)" class="btn btn-xs btn-success btn-log" data-ctl="dashboards" data-role="accountant" data-title="4"
                                                        data-id="<?= $booking->id ?>" data-code="<?= $booking->code ?>">
                                                    <i class="fa fa-spin fa-spinner hidden"></i> Xác nhận tiền nổi
                                                </button>
                                            <?php endif; ?>
                                            <button type="button" onclick="commitBooking(this, <?= $booking->id ?>, 2)" class="btn btn-xs btn-danger btn-log" data-ctl="dashboards" data-role="accountant" data-title="5"
                                                    data-id="<?= $booking->id ?>" data-code="<?= $booking->code ?>">
                                                <i class="fa fa-spin fa-spinner hidden"></i> Công nợ đại lý
                                            </button>
                                        <?php endif; ?>
                                    </td>
                                </tr>
