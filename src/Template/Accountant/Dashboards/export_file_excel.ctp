        ...
        <div class="x_content">
            ...
            <div class="form-group">
                <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                    <div class="form-group">
                        <select class="form-control select2" name="sale_id">
                            <option value="0">Chọn tất cả Sale</option>
                            <?php foreach($listSales as $k => $sale): ?>
                                <option value="<?= $sale->id ?>"><?= $sale->screen_name ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    <a onclick="exportListSaleCTVAdmin(this)" class="btn btn-success" id="blog-submit">
