                ...
                <table class=" table table-responsive table-striped">
                    <?php if ($booking->type != LANDTOUR): ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <?= number_format($booking->price + $totalSurchargePrice - $booking->sale_revenue - $booking->revenue) ?>
                            </td>
                        </tr>
                        <tr>
            ...
            <div class="deligate-payment">
                <div class="row ml15 mr15 mb15 mt15">
                    ...
                    <div class="col-sm-36 text-center">
                        ...
                        <input type="hidden" name="media" value='<?= $list_images_pay_hotel ?>'/>
                        <input type="hidden" name="list_image" value='<?= $list_images_pay_hotel ?>'/>
                    </div>
                </div>
            </div>
            <div class="form-group mt10">
                <label for="" class="label-control">Ghi chú thanh toán</label>
                <textarea name="note_for_hotel_payment" class="form-control" cols="30" rows="5"><?= $booking->note_for_hotel_payment ?></textarea>
            </div>
            <button class="btn btn-success mt10">Lưu</button>
            <?= $this->Form->end() ?>
        </div>
    </div>
</div>
