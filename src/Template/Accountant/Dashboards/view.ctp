    ...
    <table class=" table table-responsive table-striped">
        ...
        <?php if ($booking->type == LANDTOUR) : ?>
            ...
            <tr>
                ...
                <td><?= $booking->booking_landtour->pick_up->name ?> - Chi
                    tiết: <?= $booking->booking_landtour->detail_pickup ?></td>
            </tr>
            <tr>
                <th scope="row">Địa điểm trả</th>
                <td><?= $booking->booking_landtour->drop_down->name ?> - Chi
                    tiết: <?= $booking->booking_landtour->detail_drop ?></td>
            </tr>
        <?php endif; ?>
...
//                        dd($bookingLogs, $userLogs);
        ...
        <form action="#" id="commentLog">
            <div class="row">
                ...
                <div class="col-sm-12">
                    <a class="btn btn-success" onclick="saveCommentLog(this)" data-title="1" data-ctl="dashboards"
                       data-role="accountant" data-id="<?= $booking->id ?>" data-code="<?= $booking->code ?>">Gửi
                        Comment</a>
                </div>
            </div>
        </form>
