...
<div class="col-md-12 col-sm-12 col-xs-12">
    <table class="table table-responsive">
        ...
        <tr>
            <th scope="row"><?= __('Vai trò') ?></th>
            <td><?= $user->role->name ?></td>
        </tr>
        <?php if ($user->parent_id == 3): { ?>
            <tr>
                <th scope="row"><?= __('Người quản lý') ?></th>
                <td><?= $manager->screen_name ?></td>
            </tr>
        <?php } endif; ?>
        <tr>
        ...
        <tr>
            <th scope="row"><?= __('Tên tài khoản') ?></th>
            <td><?= $user->bank_master ?></td>
        </tr>
        <tr>
            <th scope="row"><?= __('Mã tài khoản') ?></th>
