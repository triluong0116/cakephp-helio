...
<p><br/><strong> Mustgo.vn </strong> trân trọng cảm ơn quý khách đã lựa chọn
    ...
    <br/>
<p>- <strong>XÁC NHẬN ĐẶT PHÒNG:</strong> Quý khách vui lòng truy cập <a href="<?= \Cake\Routing\Router::url('/', true) . 'files/attachments/' . $booking->code . '_vinbooking_send_request_payment.pdf' ?>" download="">"File đính kèm"</a></p>
<p>- <strong>THÔNG TIN THANH TOÁN:</strong> Quý khách vui lòng truy cập <a href="<?= \Cake\Routing\Router::url('/', true) . 'thanh-toan-vinpearl/' . $booking->code ?>" target="_blank">"Link thanh toán"</a></p>
<br>
