            ...
            <div class="form-group">
                <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                    <?php if ($this->request->session()->read('Auth.User.role_id') == 2): ?>
                        <a onclick="exportSaleFile(this)" class="btn btn-success" id="blog-submit">
                            <i class="fa fa-cog fa-spin fa-fw hidden" id="cog-3"></i> Xuất file Excel
                        </a>
                    <?php elseif ($this->request->session()->read('Auth.User.role_id') == 5): ?>
                        <a onclick="exportSaleLandtourFile(this)" class="btn btn-success" id="blog-submit">
                            <i class="fa fa-cog fa-spin fa-fw hidden" id="cog-3"></i> Xuất file Excel
                        </a>
                    <?php endif; ?>
                </div>
