...
<div class="col-md-6 col-xs-12">
    <div class="x_panel">
        ...
        <div class="x_content">
            ...
            <div class="clearfix"></div>
            <div class="item form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12">Khuyến mãi</label>
                <div class="col-md-6 col-sm-6 col-xs-12">
...
<div class="col-md-6 col-xs-12">
    <div class="x_panel">
        ...
        <div class="x_content">
            <a class="btn btn-success" onclick="addCaption(this, '.list-caption', false)"><i class="fa fa-plus"></i>
                Thêm Mô tả<i class="fa fa-spinner fa-spin hidden"></i></a>
    ...
    <div class="x_panel">
        ...
        <div class="x_content">
            <div id="list-accessory" class="list-accessory-price">
                <?php if (isset($dataValiError['land_tour_accessories'])): ?>
                    <?php foreach ($dataValiError['land_tour_accessories'] as $k => $accessory): ?>
                        <div class="accessory-item">
                            <div class="row mt10">
                                <div class="col-xs-11 col-sm-11">
                                    <?php
                                    echo $this->Form->control('land_tour_accessories[' . $k . '][name]', [
                                        'type' => 'text',
                                        'class' => 'form-control',
                                        'label' => 'Tên *',
                                        'required' => 'required',
                                ...
                                <div class="col-xs-12 col-sm-12">
                                    <?php
                                    echo $this->Form->control('land_tour_accessories[' . $k . '][adult_price]', [
                                        'type' => 'text',
                                        'class' => 'form-control inputmask-number',
                                        'label' => 'Giá người lớn *',
                                        'required' => 'required',
                                        'default' => $accessory['adult_price']
                                    ]);
                                    ?>
                                </div>
                            </div>
            ...
            <button type="button" class="btn btn-success text-center"
                    onclick="addLandtourAccessory(this, '.list-accessory-price')"><i class="fa fa-plus"></i> Thêm
            </button>
        </div>
    </div>
    <div class="x_panel">
        ...
        <div class="x_content">
            <div id="list-drive-surchage" class="list-drive-surchage-price">
                <?php if (isset($dataValiError['land_tour_drivesurchages'])): ?>
                    <?php foreach ($dataValiError['land_tour_drivesurchages'] as $key => $drivesurchage): ?>
                        <div class="drive-surchage-item">
                            <div class="row mt10">
                                <div class="col-xs-11 col-sm-11">
                                    <?php
                                    echo $this->Form->control('land_tour_drivesurchages[' . $key . '][name]', [
                                        'type' => 'text',
                                        'class' => 'form-control',
                                        'label' => 'Tên *',
                                        'required' => 'required',
                                        'default' => $drivesurchage['name']
                                    ]);
                                    ?>
                                </div>
                                <div class="col-sm-1 col-xs-1 text-right">
                                ...
                                <div class="col-xs-6 col-sm-6">
                                    <?php
                                    echo $this->Form->control('land_tour_drivesurchages[' . $key . '][price_adult]', [
                                        'type' => 'text',
                                        'class' => 'form-control inputmask-number currency',
                                        'label' => 'Giá người lớn *',
                                        'required' => 'required',
                                        'default' => $drivesurchage['price_adult']
                                    ]);
                                    ?>
                                </div>
                                <div class="col-xs-6 col-sm-6">
                                    <?php
                                    echo $this->Form->control('land_tour_drivesurchages[' . $key . '][price_crowd]', [
                                        'type' => 'text',
                                        'class' => 'form-control inputmask-number currency',
                                        'label' => 'Giá đoàn',
                                        'required' => 'required',
                                        'default' => $drivesurchage['price_crowd']
                                    ]);
                                    ?>
                                </div>
                            </div>
            ...
            <button type="button" class="btn btn-success text-center"
                    onclick="addLandtourDriveSurchage(this, '.list-drive-surchage-price')"><i class="fa fa-plus"></i>
                Thêm
            </button>
        </div>
    </div>
...
<script>
    ...
    tinymce.init({
        selector: '#adult_description',
        setup: function (editor) {
            editor.on('init', function (e) {
                editor.setContent("<?= isset($dataValiError['adult_description']) ? $dataValiError['adult_description'] : '' ?>");
            });
        }
    });
</script>
