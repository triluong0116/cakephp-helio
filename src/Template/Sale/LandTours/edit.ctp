                ...
                <div class="controls">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="input-prepend input-group">
                            ...
                            <input type="text" name="reservation" class="custom-daterange-picker form-control" value="<?= $date ?>"/>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="x_content">
            ...
            <div class="list-email">
                <?php if ($landTour->email): ?>
                    ...
                    <?php foreach ($emails as $mailKey => $email): ?>
                        <div class="email-item">
                            <hr/>
                            <div class="row">
                                <div class="col-sm-10 col-xs-10">
                                    <?php
                                    echo $this->Form->control('list_email[' . $mailKey . '][name]', [
                                        'templates' => [
                                            'inputContainer' => '<div class="item form-group">{{content}}</div>',
                                ...
                                <div class="col-sm-1">
                                    <div class="form-group">
                                        <div class="radio">
                                            <label>
                                                <input type="checkbox" class="flat iCheck" name="list_email[<?= $mailKey ?>][is_main]" <?= (isset($email['is_main']) && $email['is_main']) ? 'checked' : '' ?> value="1">
                                            </label>
                                        </div>
                                    </div>
                                </div>
