...
//        dd($listRooms);
                    ...
                    <div class="col-sm-6 mt10">
                        <div class="control-group">
                            <div class="controls">
                                ...
                                <div class="col-md-8 col-sm-8 col-xs-12">
                                    <div class="">
                                        <input type="text" name="birthday[<?= $k ?>][<?= $c ?>]" placeholder="" class="form-control"
                                               value="<?= $item->birthday ?>" required/>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <button type="button" class="btn btn-primary" type="submit" onclick="saveEditVinpearl(this)">
