            ...
            <form action="">
                <div class="row">
                    <div class="col-sm-6 form-group">
                        ...
                        <select class="form-control" name="ctv" id="ctv">
                            <option value="1">Phạm Văn Thanh</option>
                            <option value="2">Phạm Văn Thanh</option>
                            <option value="3">Phạm Văn Thanh</option>
                            <option value="4">Phạm Văn Thanh</option>
                            <option value="5">Phạm Văn Thanh</option>
                        </select>
                    </div>
                    <div class="col-sm-6 form-group">
                        <label for="ctv">
                        ...
                        <select class="form-control" name="ctv" id="ctv">
                            <option value="1">Mường thanh</option>
                            <option value="2">Hà nội LJK</option>
                            <option value="3">Phạm Văn Thanh</option>
                            <option value="4">Phạm Văn Thanh</option>
                            <option value="5">Phạm Văn Thanh</option>
                        </select>
