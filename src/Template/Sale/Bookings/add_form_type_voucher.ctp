    ...
    <div class="x_panel">
        ...
        <div class="x_content">
            ...
            echo $this->Form->control('amount', [
                ...
                'label' => 'Số lượng *',
                'required' => 'required',
                'onchange' => 'updateTotalPriceVoucher()',
            ...
            echo $this->Form->control('price', [
                ...
                'required' => 'required',
                'readonly' => true,
                'value' => $booking ? number_format($booking->price) : ''
            ]);
            ...
            echo $this->Form->control('customer_deposit', [
                ...
                'value' => $booking ? number_format($booking->customer_deposit) : ''
            ]);
            ...
            <?php if(!$payment || ($payment && $payment->type == 0)): ?>
                ...
                <p class="fs16 mb15 text-light-blue"><input type="radio" class="iCheck payment-check" name="payment_type" value="<?= PAYMENT_OFFICE; ?>" data-field-id="payment-office"> Thanh toán tại văn phòng</i></p>
                <p class="fs16 mb15 text-light-blue"><input type="radio" class="iCheck payment-check" name="payment_type" value="<?= PAYMENT_HOME; ?>" data-field-id="payment-home"> Thanh toán tại nhà</i></p>
                <fieldset class="scheduler-border payment-fieldset" id="payment-home">
                    <div class="row ml15 mr15 mb15 mt15">
                        <div class="col-sm-36">
                            <p class="fs14 mb10">Địa chỉ thanh toán</p>
                            <p class="error-messages" id="error_address"></p>
                            <div class="form-group">
                                <textarea class="form-control" rows="5" placeholder="Địa chỉ liên hệ..." name="payment_address"></textarea>
                            </div>
                        </div>
                    </div>
                </fieldset>
            <?php else: ?>
                <?php if($payment->type== PAYMENT_TRANSFER): ?>
                    ...
                    <?php endif; ?>
                <?php endif; ?>
                <?php if($payment->type== PAYMENT_OFFICE): ?>
                    <p class="fs16 mb15 text-light-blue"><i class="fa fa-check"></i> Thanh toán tại văn phòng</p>
                <?php endif; ?>
                <?php if($payment->type== PAYMENT_HOME): ?>
                    <p class="fs16 mb15 text-light-blue"><i class="fa fa-check"></i> Thanh toán tại nhà</p>
                ...
                <?php endif; ?>
            <?php endif; ?>
            <div class="deligate-payment" style="margin-bottom: 20px">
                <div class="row ml15 mr15 mb15 mt15">
            ...
            echo $this->Form->control('sale_discount', [
                ...
                'value' => 0,
                'value' => $booking ? number_format($booking->sale_discount) : ''
            ]);
            echo $this->Form->control('agency_discount', [
                ...
                'value' => 0,
                'value' => $booking ? number_format($booking->agency_discount) : ''
            ]);
            ?>
        </div>
    </div>
...
<div class="col-md-12 col-sm-6 col-xs-12">
    <div class="x_panel">
        ...
        <div class="x_content">
            <h4 class="text-light-blue mb10">Hình thức thanh toán</h4>
            <?php if (!$payment || ($payment && $payment->type == 0)): ?>
                <p class="error-messages" id="error_type"></p>
                <p class="fs16 mb15 text-light-blue"><input type="radio" class="iCheck payment-check" name="payment_type" value="<?= PAYMENT_TRANSFER; ?>" data-field-id="payment-transfer"> Chuyển khoản ngân hàng</i></p>
                <fieldset class="scheduler-border payment-fieldset" id="payment-transfer">
...
<div class="col-md-12 col-sm-6 col-xs-12">
    <div class="x_panel">
        ...
        <div class="x_content">
            ...
            <div class="control-group">
                <div class="controls">
                    <label class="control-label col-md-2 col-sm-2 col-xs-12">Hạn thanh toán cho khách sạn hoặc đối tacs*</label>
                    <div class="col-md-10 col-sm-10 col-xs-12">
                        <div class="input-prepend input-group">
                            <span class="add-on input-group-addon"><i class="glyphicon glyphicon-calendar fa fa-calendar"></i></span>
            ...
            <fieldset class="scheduler-border paytype-information <?= $payPartnerInfor ? 'payment-paytype-hotel' : '' ?>" id="pay-for-partner">
                ...
                echo $this->Form->control('content', [
                    ...
                    'class' => 'form-control',
                    'label' => 'Nội dung thanh toán',
                    'default' => isset($information->content) ? $information->content : ''
                ]);
                ?>
            </fieldset>
        </div>
...
<div class="col-md-12 col-sm-12 col-xs-12">
    <div class="text-center">
        <button class="btn btn-success" id="saveBooking">Lưu</button>
    </div>
</div>
