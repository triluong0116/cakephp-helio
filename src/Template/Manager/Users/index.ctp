    ...
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('landtour_parent_id') ?></th>
                <th scope="col"><?= $this->Paginator->sort('username') ?></th>
                <th scope="col"><?= $this->Paginator->sort('password') ?></th>
                <th scope="col"><?= $this->Paginator->sort('screen_name') ?></th>
                <th scope="col"><?= $this->Paginator->sort('email') ?></th>
                <th scope="col"><?= $this->Paginator->sort('email_access_code') ?></th>
                <th scope="col"><?= $this->Paginator->sort('access_token') ?></th>
                <th scope="col"><?= $this->Paginator->sort('avatar') ?></th>
                <th scope="col"><?= $this->Paginator->sort('fbid') ?></th>
                <th scope="col"><?= $this->Paginator->sort('zalo') ?></th>
                <th scope="col"><?= $this->Paginator->sort('bank_code') ?></th>
                <th scope="col"><?= $this->Paginator->sort('bank_name') ?></th>
                <th scope="col"><?= $this->Paginator->sort('bank_master') ?></th>
                <th scope="col"><?= $this->Paginator->sort('is_active') ?></th>
                <th scope="col"><?= $this->Paginator->sort('ref_code') ?></th>
                <th scope="col"><?= $this->Paginator->sort('score_test') ?></th>
                <th scope="col"><?= $this->Paginator->sort('revenue') ?></th>
                <th scope="col"><?= $this->Paginator->sort('share_fb_count') ?></th>
                <th scope="col"><?= $this->Paginator->sort('share_zalo_count') ?></th>
