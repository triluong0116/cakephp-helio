                        ...
                        <table class="table table-bordered">
                            ...
                            <?php foreach ($bookings as $k => $booking): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a type="button" class="btn btn-xs btn-primary" href="<?= $this->Url->build(['controller' => 'Dashboards', 'action' => 'viewBooking', $booking->id]) ?>">Xem</a>
                                        <?php if ($booking->status == 1): ?>
                                            <?php
                                            echo $this->Form->postLink(__('Hoàn thành'), ['action' => 'finish', $booking->id], ['confirm' => __('Bạn có chắc muốn chuyển trạng thái sang hoàn thành: {0}?', $booking->code), 'class' => 'btn btn-xs btn-success']);
                                            ?>
                                        <?php endif; ?>
                                    </td>
                                </tr>
