...
<div class="bg-grey" xmlns="http://www.w3.org/1999/html">
    ...
    <?= $this->Form->create(null, ['id' => 'hotelVinBookingForm']) ?>
    ...
    <input type="hidden" name="vin_booking_type" value="<?= $data['vin_booking_type'] ?>">
    <?php if ($data['vin_booking_type'] == 1): ?>
        <?php foreach ($data['vin_room'] as $vinKey => $vinRoom): ?>
            ...
            <input type="hidden" name="vin_room[<?= $vinKey ?>][default_price]" value="<?= $vinRoom['default_price'] ?>">
            ...
            <input type="hidden" name="vin_room[<?= $vinKey ?>][package_name]" value="<?= $vinRoom['package_name'] ?>">
            <input type="hidden" name="vin_room[<?= $vinKey ?>][rateplan_id]" value="<?= $vinRoom['rateplan_id'] ?>">
            <input type="hidden" name="vin_room[<?= $vinKey ?>][allotment_id]" value="<?= $vinRoom['allotment_id'] ?>">
            <input type="hidden" name="vin_room[<?= $vinKey ?>][room_type_code]" value="<?= $vinRoom['room_type_code'] ?>">
            <input type="hidden" name="vin_room[<?= $vinKey ?>][rateplan_code]" value="<?= $vinRoom['rateplan_code'] ?>">
            <input type="hidden" name="vin_room[<?= $vinKey ?>][revenue]" value="<?= $vinRoom['revenue'] ?>">
            <input type="hidden" name="vin_room[<?= $vinKey ?>][sale_revenue]" value="<?= $vinRoom['sale_revenue'] ?>">
        <?php endforeach; ?>
    <?php else: ?>
        <?php foreach ($data['vin_room'] as $vinKey => $vinRoom): ?>
            <input type="hidden" name="vin_room[<?= $vinKey ?>][num_adult]" value="<?= $vinRoom['num_adult'] ?>">
            ...
            <?php foreach ($vinRoom['package'] as $pK => $package): ?>
                <input type="hidden" name="vin_room[<?= $vinKey ?>][package][<?= $pK ?>][room_id]" value="<?= $package['room_key'] ?>">
                <input type="hidden" name="vin_room[<?= $vinKey ?>][package][<?= $pK ?>][price]" value="<?= $package['package_pice'] ?>">
                <input type="hidden" name="vin_room[<?= $vinKey ?>][package][<?= $pK ?>][default_price]" value="<?= $package['default_price'] ?>">
                <input type="hidden" name="vin_room[<?= $vinKey ?>][package][<?= $pK ?>][package_id]" value="<?= $package['package_id'] ?>">
                <input type="hidden" name="vin_room[<?= $vinKey ?>][package][<?= $pK ?>][package_code]" value="<?= $package['package_code'] ?>">
                <input type="hidden" name="vin_room[<?= $vinKey ?>][package][<?= $pK ?>][package_name]" value="<?= $package['package_name'] ?>">
                <input type="hidden" name="vin_room[<?= $vinKey ?>][package][<?= $pK ?>][rateplan_id]" value="<?= $package['rateplan_id'] ?>">
                <input type="hidden" name="vin_room[<?= $vinKey ?>][package][<?= $pK ?>][allotment_id]" value="<?= $package['allotment_id'] ?>">
                <input type="hidden" name="vin_room[<?= $vinKey ?>][package][<?= $pK ?>][room_type_code]" value="<?= $package['room_type_code'] ?>">
                <input type="hidden" name="vin_room[<?= $vinKey ?>][package][<?= $pK ?>][rateplan_code]" value="<?= $package['rateplan_code'] ?>">
                <input type="hidden" name="vin_room[<?= $vinKey ?>][package][<?= $pK ?>][start_date]" value="<?= $package['start_date'] ?>">
                <input type="hidden" name="vin_room[<?= $vinKey ?>][package][<?= $pK ?>][end_date]" value="<?= $package['end_date'] ?>">
                <input type="hidden" name="vin_room[<?= $vinKey ?>][package][<?= $pK ?>][revenue]" value="<?= $package['revenue'] ?>">
                <input type="hidden" name="vin_room[<?= $vinKey ?>][package][<?= $pK ?>][sale_revenue]" value="<?= $package['sale_revenue'] ?>">
            <?php endforeach; ?>
        <?php endforeach; ?>
    <?php endif; ?>
                                ...
                                <div class="p10">
                                    ...
                                    <div class="footer-room-information row">
                                        ...
                                        <?php if ($this->request->session()->read('Auth.User.role_id') == 3): ?>
                                            ...
                                            <div class="col-sm-36">
                                                <p class="pull-right text-orange fs24 semi-bold">
                                                    <?= number_format($totalPrice - $totalRevenue) ?> VNĐ
                                                </p>
                                            </div>
                                        <?php endif; ?>
                                        <div class="col-sm-36">
