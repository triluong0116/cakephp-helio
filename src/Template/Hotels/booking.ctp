...
<div class="bg-grey" xmlns="http://www.w3.org/1999/html">
    ...
    <form id="hotelBookingForm">
        <div class="combo-detail pb50">
                        ...
                        <?php if ($room_id): ?>
                            <fieldset class="booking-room-item" style="position: relative">
                                ...
                                <div class="row mt30 mt05-sp">
                                    <div class="col-sm-22 col-xs-36">
                                        <div class="form-group mb05-sp">
                                            <p class="text-super-dark fs14 fs12-sp mb15 mb05-sp pc">Hạng phòng<span class="text-grey fs12"></span></p>
                                            <select class="form-control popup-voucher" id="agency_room" name="booking_rooms[0][room_id]">
                                                <?php foreach ($rooms as $k => $val): ?>
                                                    <option value="<?= $k ?>"><?= $val ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                            <p id="error_booking_rooms_0_room_id" class="error-messages"></p>
                                        </div>
                                    </div>
                                    <div class="col-sm-14 col-xs-36">
                                        <div class="form-group mb05-sp">
                                            ...
                                            <select class="form-control popup-voucher select-no-arrow" name="booking_rooms[0][num_room]">
                                                <?php for ($i = 1; $i <= 50; $i++): ?>
                                                    <option value="<?= $i ?>" <?= $num_room == $i ? 'selected' : '' ?>><?= $i ?> Phòng</option>
                                                <?php endfor; ?>
                                            </select>
                                ...
                                <div class="row mt10-pc mt05-sp">
                                    <div class="col-sm-18 col-xs-18">
                                        ...
                                        <div class='input-group date datepicker room-booking-sDate'>
                                            ...
                                            <input type='text' readonly="readonly" name="booking_rooms[0][start_date]" class="form-control popup-voucher" placeholder="Thời gian đi" value="<?= $fromDate ?>"/>
                                        </div>
                                    ...
                                    <div class="col-sm-18 col-xs-18">
                                        ...
                                        <div class='input-group date datepicker room-booking-eDate'>
                                            <span class="input-group-addon"><span class="far fa-calendar-alt main-color"></span></span>
                                            <input type='text' readonly="readonly" name="booking_rooms[0][end_date]" class="form-control popup-voucher" placeholder="Thời gian về" value="<?= $toDate ?>"/>
                                        </div>
                                ...
                                <div class="row mt10-pc mt05-sp">
                                            ...
                                            <div class="col-sm-18 col-xs-18">
                                                <div class="form-group mb05-sp">
                                                    ...
                                                    <select class="form-control popup-voucher select-no-arrow" name="booking_rooms[0][num_adult]">
                                                        <?php for ($i = 1; $i <= 50; $i++): ?>
                                                            <option value="<?= $i ?>" <?= $num_adult == $i ? 'selected' : '' ?>><?= $i ?> Người lớn</option>
                                                        <?php endfor; ?>
                                                    </select>
                                                    <p id="error_booking_rooms_0_num_adult" class="error-messages"></p>
                                                </div>
                                            </div>
                                            <div class="col-sm-18 col-xs-18">
                                                <div class="form-group mb05-sp">
                                                    ...
                                                    <select class="form-control popup-voucher select-no-arrow booking-num-child" name="booking_rooms[0][num_children]">
                                                        <?php for ($i = 0; $i <= 50; $i++): ?>
                                                            <option value="<?= $i ?>" <?= $num_children == $i ? 'selected' : '' ?>><?= $i ?> Trẻ em</option>
                                                        <?php endfor; ?>
                                                    </select>
                                                    <p id="error_booking_rooms_0_num_children" class="error-messages"></p>
                                                </div>
                                            </div>
                                            <div class="col-sm-36">
                                    ...
                                    <div class="col-sm-18 col-xs-36">
                                        <div class="row">
                                            <p class="text-super-dark fs14 fs12-sp ml15 mb15 mb05-sp">Tuổi của các bé<span class="text-grey fs12"></span></p>
                                                    ...
                                                    <div class="col-sm-9 col-xs-9 no-pad-left-sp">
                                                        <div class="form-group vertical-center mb05-sp">
                                                            ...
                                                            <div class="col-sm-28 col-xs-36">
                                                                <select class="form-control popup-voucher children-age-selector select-no-arrow" name="booking_rooms[0][child_ages][]">
                                                                    <?php for ($j = 0; $j <= 18; $j++): ?>
                    ...
                    <div class="row mt15">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <p class="text-super-dark fs14 fs12-sp mb15">Họ và tên đoàn trưởng<span class="text-grey fs12"></span></p>
                                <input class="form-control popup-voucher" id="full_name" placeholder="Họ và tên" name="full_name">
                                <p id="error_full_name" class="error-messages"></p>
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group">
                                <p class="text-super-dark fs14 fs12-sp mb15">Số điện thoại trưởng đoàn<span class="text-grey fs12"></span></p>
                                <input class="form-control popup-voucher" id="phone" placeholder="Số điện thoại" name="phone">
                                <p id="error_phone" class="error-messages"></p>
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group">
                                <p class="text-super-dark fs14 fs12-sp mb15">Email<span class="text-grey fs12"></span></p>
                                <?php if ($this->request->getSession()->read('Auth.User')): ?>
                                    <input class="form-control popup-voucher" placeholder="Email" name="email" value="<?= $this->request->getSession()->read('Auth.User.email') ?>">
                                <?php else: ?>
                                    <input class="form-control popup-voucher" placeholder="Email" name="email" required="required">
                                <?php endif; ?>
                            ...
                            <?php foreach ($autoSurcharges as $key => $surcharge): ?>
                                <div class="normal-surcharge-item">
                                    <div class="row ml15 mt15 mb15 mr15 ml0-sp mr0-sp">
                                        <input type="hidden" name="booking_surcharges[<?= $key ?>][surcharge_type]" value="<?= $surcharge['surcharge_type'] ?>">
                                        <input type="hidden" name="booking_surcharges[<?= $key ?>][id]" value="<?= $surcharge['id'] ?>">
                                        <input type="hidden" name="booking_surcharges[<?= $key ?>][price]" value="" id="<?= SystemHelper::getSurchargeId($surcharge['surcharge_type'], $surcharge['other_slug']) ?>" class="booking-value">
                                        <div class="col-sm-18 col-xs-18 text-left">
                                            <p class="fs16 fs12-sp"><i data-toggle="tooltip" title="<?= $surcharge['description'] ?>"><?= SystemHelper::getSurchargeName($surcharge['surcharge_type']) ?></i></p>
                                        </div>
                                        <div class="col-sm-18 col-xs-18 text-right">
                                            <p class="fs16 main-color fs12-sp" id="<?= SystemHelper::getSurchargeId($surcharge['surcharge_type'], $surcharge['other-slug'], false) ?>"><?= number_format($surcharge['fee'], false) ?></p>
                                        </div>
                                    </div>
                                </div>
                            <?php endforeach; ?>
                        ...
                        <div id="list-normal-surcharge">
                                    ...
                                    <div class="row ml15 mr15 mb15 mt15 ml0-sp mr0-sp vertical-center">
                                        <div class="col-sm-12 col-xs-12 text-left">
                                            ...
                                            <p class="fs16 fs12-sp">
                                                <input type="checkbox" class="iCheck surcharge-check" name="booking_surcharges[<?= $key ?>][surcharge_type]" value="<?= $surcharge->surcharge_type ?>">
                                        ...
                                        <div class="col-sm-12 col-xs-16">
                                            <div class="surcharge-normal-quantity">
                                                <div class="form-group">
                                                        ...
                                                        <div class="row vertical-center">
                                                            ...
                                                            <div class="col-sm-18 col-xs-26">
                                                                <div class='input-group date timepicker'>
                                                                    <input type='text' class="form-control popup-voucher normal-surcharge-value" name="booking_surcharges[<?= $key ?>][quantity]"/>
                                                    ...
                                                    <?php else: ?>
                                                        <div class="row vertical-center">
                                                            ...
                                                            <div class="col-sm-18 col-xs-26">
                                                                <select class="form-control popup-voucher normal-surcharge-value" id="amount" name="booking_surcharges[<?= $key ?>][quantity]">
                                                                    <option value=""></option>
                                                                    <?php for ($i = 1; $i <= 10; $i++): ?>
                                        ...
                                        <div class="col-sm-12 col-xs-8 text-right">
                                            <input type="hidden" class="booking-value surcharge-price" id="<?= SystemHelper::getSurchargeId($surcharge['surcharge_type'], $surcharge['other_slug']) ?>" name="booking_surcharges[<?= $key ?>][price]" value="<?= $surcharge->price ?>"/>
                                            <p class="fs16 fs12-sp main-color"><span class="normal-surcharge-fee" id="<?= SystemHelper::getSurchargeId($surcharge['surcharge_type'], $surcharge['other_slug'], false) ?>">0</span></p>
                                        </div>
                                    </div>
                                </div>
                            <?php endforeach; ?>
                            <?php if ($hotel->is_special == 1): ?>
                                ...
                                <div class="row mt10 ml15 mr15 mb10 ml0-sp mr0-sp">
                                    <div class="col-sm-36">
                                        <div class="form-group">
                                            <p class="text-super-dark fs14 mb15">Danh sách đoàn<span class="text-grey fs12"></span></p>
                            ...
                            <div class="row ml15 mr15 mb10 mr0-sp ml0-sp">
                                <div class="col-sm-36">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" rows="5" name="other" id="comment"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row mt20">
                    ...
                    <div class="col-sm-9">
                        <div class="text-white">
                            <button type="button" class="btn btn-request-booking btn-block semi-bold text-white full-height" id="requestBooking">
            ...
            <!--                    <div class="col-sm-18">-->
            <!--                        <div class="bg-white p10">-->
            <!--                            <p class="text-super-dark fs14">Khách sạn abc, hạng phòng 5 sao, checkin 25/4/2019</p>-->
            <!--                            <p class="text-super-dark fs14">check out 25/4/2019,5 phòng, 10 người lớn</p>-->
            <!--                        </div>-->
            <!--                    </div>-->
            <!--                    <div class="col-sm-9 text-center">-->
            <!--                        <div class="bg-white p10">-->
            <!--                            <p class="text-super-dark fs14 mb5">Giá tiền</p>-->
            <!--                            <p class="text-super-dark fs14">1.000.000 VNĐ</p>-->
            <!--                        </div>-->
            <!--                    </div>-->
            <!--                    <div class="col-sm-9 text-center">-->
            <!--                        <div class="bg-white p10">-->
            ...
            <!--                                <p class="fs12"><input type="checkbox" class="iCheck rating-checkbox" value=""> Khách hàng thanh toán trực tiếp cho Mustgo</i> <span class="fs12 ml20"><input type="checkbox" class="iCheck rating-checkbox" value="">  Đại lý thu hộ cho Mustgo</i></span></p>-->
            <!--                            </div>-->
            <!--                        </div>-->
            <!--                    </div>-->
            <!--                    <div class="col-sm-9">-->
            <!--                        <a class="btn btn-request-booking text-white full-width full-height"-->
            <!--                        <span class="semi-bold fs20">GỬI YÊU CẦU</span>-->
            <!--                        </a>-->
            <!--                    </div>-->
            <!--                </div>-->
