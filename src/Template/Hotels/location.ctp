                ...
                <div class="col-sm-12 col-xs-36 mb30">
                    <div class="location-item">
                        <div class="rectangle-image">
                            <a onclick="Frontend.findAgencyWithoutLoadingVer2(this);" data-href="<?= \Cake\Routing\Router::url(['_name' => 'location.hotel', 'slug' => $location->slug]) ?>">
                            ...
                            <div class="caption" data-href="<?= \Cake\Routing\Router::url(['_name' => 'location.hotel', 'slug' => $location->slug]) ?>" onclick="Frontend.findAgencyWithoutLoadingVer2(this);">
                                <div class="location-title">
                                    <a class="fs20 semi-bold text-white text-uppercase box-underline-center-white" href="<?= \Cake\Routing\Router::url(['_name' => 'location.hotel', 'slug' => $location->slug]) ?>">
                                        <?= $location->name ?>
                                    </a>
                                </div>
