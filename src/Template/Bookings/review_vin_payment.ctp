                            ...
                            if ($booking->status == 1) {
                                if ($booking->vinpayment && $booking->vinpayment->images) {
                                    if ($booking->user_id == $booking->sale_id) {
                                        echo 'Khách lẻ mới đặt, đã up UNC';
                                    } else {
                                ...
                                if ($booking->vinpayment && ($booking->vinpayment->type == PAYMENT_ONEPAY_QR || $booking->vinpayment->type == PAYMENT_ONEPAY_ATM || $booking->vinpayment->type == PAYMENT_ONEPAY_CREDIT)) {
                                    if ($booking->vinpayment->onepaystatus == 0) {
                                        if ($booking->user_id == $booking->sale_id) {
                                            echo 'Khách lẻ mới đặt, thanh toán Onepay thành công';
                                        } else {
                                            echo 'Đại lý mới đặt, thanh toán Onepay thành công';
                                        }
                                    } else {
                                        if ($booking->user_id == $booking->sale_id) {
                                            echo 'Khách lẻ mới đặt, thanh toán Onepay không thành công';
                                        } else {
                                ...
                                if (!$booking->vinpayment || !$booking->vinpayment->images) {
                                    if ($booking->user_id == $booking->sale_id) {
                                        echo 'Khách lẻ mới đặt, chưa up UNC';
                                    } else {
        ...
        <div class="container ">
            <div class="bg-white p20" style="min-height: 200px">
                ...
                <div class="col-sm-36 mb15">
                    ...
                    <div class="col-sm-18">
                        <p class="fs14 mb10"><span class="text-red"><?= number_format($bookingPrice - $booking->agency_discount - $booking->sale_discount) ?> VNĐ</span></p>
                    </div>
                    <?php if ($booking->user_id != $booking->sale_id): ?>
                        ...
                        <div class="col-sm-18">
                            <p class="fs14 mb10"><span class="text-red"><?= number_format($bookingPrice - $booking->revenue - $booking->agency_discount - $booking->sale_discount) ?> VNĐ</span></p>
                        </div>
                    <?php endif; ?>
                    <div class="col-sm-18">
