...
<div class="bg-grey" xmlns="http://www.w3.org/1999/html">
    ...
    <form id="hotelChannelBookingForm">
            ...
            <div class="container ">
                <div class="row">
                                                ...
                                                <div class="panel panel-price panel-default">
                                                    ...
                                                    <div id="collapseTerm" class="panel-collapse collapse">
                                                        <div class="panel-body panel-price-body">
                                                            <div class="row">
                                                                <?php $total = 0; ?>
                                                                <?php foreach ($booking->channelbooking_rooms as $roomKey => $room): ?>
                                                                    <div class="single-room-detail">
                                                                        <div class="col-sm-20 col-xs-20 mt10">
                                                                            <p class="fs14">Phòng <?= $roomKey + 1 ?>: <?= $room->channelroom->name ?></p>
                                                                        </div>
                    ...
                    <div class="col-sm-24 mt20 no-pad-right no-pad-left">
                        <div class="w100">
                            <button type="button" class="btn w100 btn-payment text-uppercase" id="requestChannelPayment">Thanh toán</button>
                        </div>
                    </div>
                </div>
            </div>
