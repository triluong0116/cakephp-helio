...
?>
            ...
            <div class="x_content">
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <input name="contract_file_edit" type="hidden" value='<?= $landTour->contract_file ?>'/>
                    </div>
                    <?php if ($landTour->contract_file) : ?>
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-3">
                                <a href="<?= \Cake\Routing\Router::url('/', true) . $landTour->contract_file ?>" target="_blank">File hợp đồng</a>
                            </div>
                        </div>
                    <?php endif; ?>
                </div>
    ...
    <div class="col-md-6 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                <a class="btn btn-success" onclick="addCaption(this, '.list-caption')"><i class="fa fa-plus"></i> Thêm Mô tả <i class="fa fa-spinner fa-spin hidden"></i></a>
