                    ...
                    <div class="row mt10">
                        <div class="col-sm-9 col-xs-36 mb05-sp">
                            ...
                            <div class='input-group date datepicker mt15 mt05-sp homestay' id="start-date-picker">
                                ...
                                <input type='text' name="start_date" class="form-control popup-voucher"
                                       value="<?= date_format($booking->start_date, 'd-m-Y') ?>"/>
                            </div>
                        ...
                        <div class="col-sm-9 col-xs-36 mb0-sp">
                            <div class="form-group">
                                ...
                                <select class="form-control popup-voucher select-no-arrow" name="num_adult" onchange="Frontend.calLandtourDriveSurcharge()">
                                    <?php for ($i = 1; $i <= 50; $i++): ?>
                                        <option
                                            value="<?= $i ?>" <?= $booking->booking_landtour->num_adult == $i ? 'selected' : '' ?>><?= $i ?>
                                            Người lớn
                                        </option>
                                    <?php endfor; ?>
                                </select>
                                ...
                                <div class="col-sm-36 col-xs-36">
                                    <div class="form-group">
                                        ...
                                        <select
                                            ...
                                            <?php for ($i = 0; $i <= 50; $i++): ?>
                                                <option
                                                    value="<?= $i ?>" <?= $booking->booking_landtour->num_children == $i ? 'selected' : '' ?>><?= $i ?>
                                                    Trẻ em
                                                </option>
                                            <?php endfor; ?>
                                        </select>
                                ...
                                <div class="col-sm-36 col-xs-36">
                                    <div class="form-group">
                                        ...
                                        <select
                                            ...
                                            <?php for ($i = 0; $i <= 50; $i++): ?>
                                                <option
                                                    value="<?= $i ?>" <?= $booking->booking_landtour->num_kid == $i ? 'selected' : '' ?>><?= $i ?>
                                                    Trẻ em
                                                </option>
                                            <?php endfor; ?>
                                        </select>
                                ...
                                <?php foreach ($landTour->land_tour_accessories as $k => $access): ?>
                                    <div class="col-sm-36">
                                        <p class="fs16 mb15 text-light-blue">
                                            <input type="checkbox"
                                                   class="iCheck" <?= in_array($access->id, $accessory) ? 'checked' : '' ?>
                                                   name="accessory[]"
                                                   value="<?= $access->id; ?>">
                                            <?= $access->name ?></i></p>
                                    </div>
                            ...
                            <div class="form-group">
                                <div class="row ml40">
                                    <p class="text-super-dark fs14 fs12-sp mb15">Địa chỉ đón khách<span
                                            class="text-grey fs12"></span></p>
                                    <div class="col-sm-12">
                                        <select class="form-control popup-voucher select-no-arrow" name="pickup_id" onchange="Frontend.calLandtourDriveSurcharge()">
                                            ...
                                            <?php if (count($landTour->land_tour_drivesurchages) > 0): ?>
                                                <?php foreach ($landTour->land_tour_drivesurchages as $k => $drivesurchage): ?>
                                                    <option
                                                        value="<?= $drivesurchage->id ?>" <?= $booking->booking_landtour->pickup_id == $drivesurchage->id ? 'selected' : '' ?>>
                                                        <?= $drivesurchage->name ?>
                                                    </option>
                                                <?php endforeach; ?>
                                            <?php endif; ?>
                                    ...
                                    <div class="col-sm-24"><input class="form-control popup-voucher"
                                                                  ...
                                                                  value="<?= $booking->booking_landtour->detail_pickup ?>">
                                    </div>
                                </div>
                                <div class="form-group mt30">
                                    <div class="row ml40">
                                        <p class="text-super-dark fs14 fs12-sp mb15">Địa chỉ trả khách<span
                                                class="text-grey fs12"></span></p>
                                        <div class="col-sm-12">
                                            <select class="form-control popup-voucher select-no-arrow" name="drop_id" onchange="Frontend.calLandtourDriveSurcharge()">
                                                <option selected="true" disabled="disabled">Chọn Điểm trả</option>
                                                <?php if (count($landTour->land_tour_drivesurchages) > 0): ?>
                                                    <?php foreach ($landTour->land_tour_drivesurchages as $k => $drivesurchage): ?>
                                                        <option
                                                            value="<?= $drivesurchage->id ?>" <?= $booking->booking_landtour->drop_id == $drivesurchage->id ? 'selected' : '' ?>>
                                                            <?= $drivesurchage->name ?>
                                                        </option>
                                                    <?php endforeach; ?>
                                                <?php endif; ?>
                                        ...
                                        <div class="col-sm-24"><input class="form-control popup-voucher"
                                                                      ...
                                                                      value="<?= $booking->booking_landtour->detail_drop ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="normal-surcharge-item">
                                <div class="row vertical-center">
                                    ...
                                    <div class="col-sm-16 col-xs-18 text-right">
                                        <p class="fs16 fs13-sp main-color"><span id="total_booking_drive_surcharge"><?= number_format($booking->booking_landtour->drive_surchage) ?></span> VNĐ
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="row mt10">
                                <div class="col-sm-36">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" rows="5" name="other"><?= $booking->other ?></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="bg-white p05">
                                    ...
                                    <div class="form-group row mt10">
                                        <div class="col-sm-16 col-xs-36">
                                            <input type="radio" class="iCheck payment-method-check" value="<?= AGENCY_PAY ?>" <?= $booking->payment_method == AGENCY_PAY ? "checked" : "" ?> name="payment_method"> Đại lý thanh toán cho Mustgo</i>
                                        </div>
                                        <div class="col-sm-16 col-xs-36">
                                            <input type="radio" class="iCheck payment-method-check" value="<?= MUSTGO_DEPOSIT ?>" <?= $booking->payment_method == MUSTGO_DEPOSIT ? "checked" : "" ?> name="payment_method">  Mustgo thu hộ</i></span
                                        </div>
                                        <p id="error_payment_method" class="error-messages"></p>
                                    </div>
                                    <div class="form-group row ml10 mt10 mustgo-deposit" <?= $booking->payment_method == MUSTGO_DEPOSIT ? '' : 'style="display: none"' ?>
                                        <div class="col-sm-36 col-xs-36">
                                            <p class="text-super-dark fs14 fs12-sp mb15 mt15">Số tiền thu hộ<span
                                                    class="text-grey fs12"></span></p>
                                            <input class="form-control popup-voucher" onkeyup="Frontend.calLandTourTotalPrice()" id="full_name" placeholder="Số tiền thu hộ" value="<?= $booking->mustgo_deposit ?>"
                                                   name="mustgo_deposit">
                                        </div>
                                    </div>
                                </div>
