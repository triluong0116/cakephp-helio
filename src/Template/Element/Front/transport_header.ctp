                    ...
                    <div class="row">
                        <div id="header-menu" class="navbar-collapse collapse">
                            <ul class="nav navbar-nav main-menu">
                                <li class="<?= $currentController == "Hotels" && ($currentAction == "location" || $currentAction == "view") ? "active" : "" ?>"><a href="<?= $this->Url->build('/khach-san/dia-diem') ?>">Khách sạn</a></li>
                                        ...
                                        <div class="dropdown ml50-sp" style=" display: block; padding: 8px">
                                            ...
                                            <ul class="dropdown-menu account">
                                                <?php if ($this->request->getSession()->read('Auth.User.is_active') == 1): ?>
                                                    ...
                                                    <li><a target="_blank" href="<?= $this->Url->build('/flight') ?>">Tìm chuyến bay</a></li>
                                                    <li><a target="_blank" href="<?= $this->Url->build('/thue_xe_co_lai') ?>">Thuê xe có lái</a></li>
                                                <?php endif; ?>
