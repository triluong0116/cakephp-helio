    ...
    <div class="modal-dialog ">
        ...
        <div class="modal-content modal-voucher ">
            <div class="modal-header text-center pt25">
                ...
                <h4 class="modal-title bold fs25 mt20">Chi tiết Hotel</h4>
            </div>
            <div class="modal-body">
                <form id="addBooking">
                    <div class="fs16 mb15">
                        <p>Vui lòng điền thông tin Khách sạn</p>
                    </div>
                    ...
                    <div class="form-group">
                        <p class="text-super-dark fs14 mb15">Số phòng<span class="text-grey fs12"></span></p>
                        <input class="form-control popup-voucher inputmask-number" id="agency_amount" placeholder="Số Phòng" name="amount">
                        <p id="error_phone" class="error-messages"></p>
                    </div>
                    <div class="form-group">
                        <p class="text-super-dark fs14 mb15">Loại phòng<span class="text-grey fs12"></span></p>
                        <select class="form-control popup-voucher" id="agency_room" name="room_level">
                            <?php foreach ($hotel->rooms as $singleKey => $room): ?>
                                <option value="<?= $room->id ?>"><?= $room->name ?></option>
                            <?php endforeach; ?>
                        </select>
                        <p id="error_rooms" class="error-messages"></p>
                    </div>
                    <div class="row mb20">
                        <div class="col-sm-18">
                        ...
                        <div class="col-sm-18">
                            ...
                            <div class='input-group date datepicker' id="booking-end-date">
                                ...
                                <input type='text' name="end_date" class="form-control popup-voucher" placeholder="Thời gian về"/>
                            </div>
                        </div>
                        <p id="error_date" class="error-messages"></p>
                    </div>
                    <div class="form-group">
                        <p class="text-super-dark fs14 mb15">Số người lớn + trẻ em<span class="text-grey fs12"></span></p>
                        <input class="form-control popup-voucher" id="numPeople" placeholder="Số người lớn + trẻ em" name="people_amount">
                        <p id="error_people" class="error-messages"></p>
                    </div>
                    <div class="form-group">
                    ...
                    <?php if ($isSpecialHotel): ?>
                        <div class="form-group">
                            ...
                            <textarea rows="10" class="form-control popup-voucher border-light-blue" id="agency_information" placeholder="Danh sách đoàn, ngày sinh của trẻ em" name="information"></textarea>
                            <p id="error_information" class="error-messages"></p>
                        </div>
                    <?php endif; ?>
                    <div class="form-group">
                    ...
                    <div class="row pt25 pb25">
                        <div class="col-sm-12 col-sm-offset-12">
                            <input type="button" name="btn-submit" class="form-control btn btn-submit" onclick="Frontend.addBookingHotel()" value="Gửi">
                        </div>
                    </div>
                </form>
            </div>
