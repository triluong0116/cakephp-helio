    ...
    <div class="modal-dialog ">
        ...
        <div class="modal-content modal-voucher ">
            <div class="modal-header text-center pt25">
                ...
                <h4 class="modal-title bold fs25 mt20">Chi tiết Homestay</h4>
            </div>
            <div class="modal-body">
                <form id="addBooking">
                    <div class="fs16 mb15">
                        <p>Vui lòng điền thông tin Homestay</p>
                    </div>
                    ...
                    <div class="row pt25 pb25">
                        <div class="col-sm-12 col-sm-offset-12">
                            <input type="button" name="btn-submit" class="form-control btn btn-submit" onclick="Frontend.addBookingHomestay()" value="Gửi">
                        </div>
                    </div>
                </form>
            </div>
