    ...
    <div class="modal-dialog ">
        ...
        <div class="modal-content modal-voucher ">
            <div class="modal-header text-center pt25">
                ...
                <h4 class="modal-title bold fs25 mt20">Chi tiết Voucher</h4>
            </div>
            <div class="modal-body">
                <form id="addBooking">
                    <div class="fs16 mb15">
                        <p>Vui lòng điền thông Voucher</p>
                    </div>
                    <input type="hidden" name="user_id" value="">
                    <input type="hidden" name="item_id" value="<?= $voucher->id ?>">
                    ...
                    <div class="form-group">
                        <p class="text-super-dark fs14 mb15">Số Voucher <span class="text-grey fs12"></span></p>
                        <input class="form-control popup-voucher inputmask-number" id="agency_amount" placeholder="Số Voucher" name="amount">
                    ...
                    <div class="row mb20">
                        ...
                        <div class="col-sm-36"><p id="error_date" class="error-messages"></p></div>
                    </div>
                    <div class="form-group">
                    ...
                    <?php if ($voucher->hotel->is_special == 1): ?>
                        <div class="form-group">
                            <p class="text-super-dark fs14 mb15">Danh sách đoàn, ngày sinh của trẻ em</p>
                            <textarea rows="10" class="form-control popup-voucher border-light-blue" id="agency_information" placeholder="Thông tin" name="information"></textarea>
                    ...
                    <div class="row pt25 pb25">
                        <div class="col-sm-12 col-sm-offset-12">
                            <input type="button" name="btn-submit" class="form-control btn btn-submit" onclick="Frontend.addBookingVoucher()" value="Gửi">
                        </div>
                    </div>
                </form>
            </div>
