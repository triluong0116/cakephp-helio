 ...
 * @var \App\Model\Entity\HomeStay[]|\Cake\Collection\CollectionInterface $homeStays
 */
?>
                                        ...
                                        <div class="col-sm-12 mb15">
                                            <div class="combo-item border-bottom-blue">
                                                <div class="wrap-content rectangle-image-v2">
                                                    <a href="<?= \Cake\Routing\Router::url(['_name' => 'homestay.view', 'slug' => $combo->slug]) ?>">
                                                    ...
                                                    <div class="top-left text-white">
                                                        <p><i class="fas fa-map-marker-alt text-pink fs16"></i>&nbsp;&nbsp;<?= $combo->location->name ?></p>
                                                    </div>
                                                    <div class="middle-button">
                                                        <div class="button-text text-center ">
                                                            <a class="fs12" href="<?= \Cake\Routing\Router::url(['_name' => 'homestay.view', 'slug' => $combo->slug]) ?>">XEM NGAY</a>
                                                        </div>
                                                    </div>
                                                    <div class="image-bottom-content combo-rating fs13 pl05">
                                                        <div class="row">
                                                            <div class="col-sm-22 col-xs-25">
                                                                <p class="pc"><?= $this->System->splitByWords($combo->name, 15) ?></p>
                                                                <p class="sp"><?= $this->System->splitByWords($combo->name, 25) ?></p>
                                                            </div>
                                                            <div class="col-sm-14 col-xs-11">
                                                                <p class="star-rating text-right" data-point="<?= $combo->rating ?>"></p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="combo-detail overhidden pb10">
                                                    <div class="semi-bold voucher-name">
                                                        <a class="semi-bold text-super-dark fs16" href="<?= \Cake\Routing\Router::url(['_name' => 'homestay.view', 'slug' => $combo->slug]) ?>">
                                                            <?= $this->System->splitByWords($combo->name, 75) ?>
                                                        </a>
                                                    </div>
                                                    <div class="pl05 pr05">
                                                        <div class="row fs13">
                                                            ...
                                                            <div class="col-sm-19 col-xs-19 no-pad-left text-right">
                                                                <span class="fs12 text-grey"><strong class="text-orange"><?= number_format($combo->totalPrice) ?></strong> đ/đêm</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
