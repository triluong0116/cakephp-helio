...
<div class="col-md-6 col-xs-12">
    <div class="x_panel">
        ...
        <div class="x_content">
            ...
            <a class="btn btn-success" onclick="addVinCaption(this, '.list-vin-caption')"><i class="fa fa-plus"></i> Thêm tiện ích <i class="fa fa-spinner fa-spin hidden"></i></a>
    ...
    <div class="x_panel">
        ...
        <div class="x_content">
            ...
            <input type="hidden" name="vinhms_meeting_media" value=''/>
            <input type="hidden" name="vinhms_meeting_list_image" value=''/>
        </div>
    </div>
    <div class="x_panel">
        <div class="x_title">
