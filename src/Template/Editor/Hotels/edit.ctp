...
<div class="col-md-6 col-xs-12">
    <div class="x_panel">
        ...
        <div class="x_content">
            ...
            <div class="item form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12">File Khuyến mãi</label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="file" name="promotion"/>
                    <input name="promotion_edit" type="hidden" value='<?= $hotel->promotion ?>'/>
                </div>
                <?php if ($hotel->promotion) : ?>
                    <div class="form-group">
                        <div class="col-md-6 col-md-offset-3">
                            <a class="btn btn-default" href="<?= \Cake\Routing\Router::url('/', true) . $hotel->promotion ?>" target="_blank"><?= basename($hotel->promotion) ?></a>
                        </div>
                    </div>
                <?php endif; ?>
            </div>
