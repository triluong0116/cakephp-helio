                ...
                <div class="controls">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="input-prepend input-group">
                            ...
                            <input type="text" name="reservation" class="custom-daterange-picker form-control" value="<?= (isset($dataValiError['reservation']) && !empty($dataValiError['reservation'])) ? $dataValiError['reservation'] : date_format($booking->start_date, 'd-m-Y') . ' - ' . date_format($booking->end_date, 'd-m-Y') ?>" />
                        </div>
                    </div>
                </div>
            </div>                        
