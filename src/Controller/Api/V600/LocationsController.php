...
//            $limit = $this->request->getQuery('limit');
            $limit = '';
            if ($limit) {
                $locations = $this->Locations->find()->where()->order(['is_featured' => 'DESC'])->limit($limit)->toArray();
                ...
                foreach ($locations as $location){
                    ...
                    $data['thumbnail'] = $location['thumbnail'];
                    $data['hotel_count'] = $location['hotel_count'];
                    $listLocation[] = $data;
                }
                $this->set([
                    'status' => STT_SUCCESS,
                ...
                $locations = $this->Locations->find()->where()->order(['is_featured' => 'DESC'])->toArray();
