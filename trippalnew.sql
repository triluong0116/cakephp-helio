...
-- Dumping data for table trippal.blogs: ~1 rows (approximately)
/*!40000 ALTER TABLE `blogs` DISABLE KEYS */;
INSERT INTO `blogs` (`id`, `user_id`, `title`, `slug`, `caption`, `description`, `thumbnail`, `created`, `modified`) VALUES
	(1, 0, 'Cẩm nang', 'cam-nang', 'Mô tả ngắn', '<p>lội cmn dung</p>\r\n<p><img src="http://localhost/trippal/files/uploads/1539070032-book.jpg" alt="" width="714" height="476" />123</p>', '', '2018-10-09 07:27:15', '2019-01-19 17:52:46');
...
-- Dumping data for table trippal.bookings: ~0 rows (approximately)
...
-- Dumping data for table trippal.combos_hotels: ~11 rows (approximately)
...
-- Dumping data for table trippal.configs: ~8 rows (approximately)
...
INSERT INTO `configs` (`id`, `type`, `value`, `status`, `created`, `modified`) VALUES
	...
	(8, 'anh-background', 'files/uploads/1548648408-logo.png', 0, '0000-00-00 00:00:00', '2019-01-28 11:06:48');
...
-- Dumping data for table trippal.fanpages: ~3 rows (approximately)
...
-- Dumping data for table trippal.hotels: ~14 rows (approximately)
...
INSERT INTO `hotels` (`id`, `name`, `is_special`, `icon_list`, `slug`, `description`, `caption`, `location_id`, `thumbnail`, `media`, `fb_content`, `rating`, `address`, `map`, `hotline`, `term`, `email`, `price_agency`, `price_customer`, `created`, `modified`) VALUES
	(1, 'Khách sạn 5 sao', 0, '[]', 'khach-san-5-sao', '<p>M&ocirc; tả</p>', 'null', 5, 'files/uploads/1539331428-sport.jpg', '', '13', 3, '123', 'Map here', '09000009999', '<p>Ch&iacute;nh s&aacute;ch g&igrave; đ&oacute;</p>', 'null', 0, 0, '2018-10-11 03:28:18', '2019-02-02 13:37:36'),
	...
	(23, '123123', 0, '["fas fa-check"]', '123123', '<p>123</p>', '[{"icon":"fas fa-check","content":"123"}]', 5, 'files/uploads/1548059795-Pikachu-Running-Picture.png', '["files/uploads/1548059788-48417226_1958541020849323_9173472707377889280_n.jpg"]', '123', 5, 'nhà 910 số 47 vũ trọng phụng, thanh xuân, hà nội', '', '123', '<p>123</p>', '["zzphonixzz@gmail.com"]', 222222, 333333, '2019-01-21 15:36:36', '2019-01-21 15:36:36');
...
-- Dumping data for table trippal.hotels_categories: ~196 rows (approximately)
...
-- Dumping data for table trippal.price_hotels: ~23 rows (approximately)
...
INSERT INTO `price_hotels` (`id`, `hotel_id`, `start_date`, `end_date`, `price`, `created`, `modified`) VALUES
	...
	(23, 23, '2019-01-21', '2019-01-21', 120000, '2019-01-21 15:36:40', '2019-01-21 15:36:40');
...
-- Dumping data for table trippal.promotes: ~5 rows (approximately)
...
-- Dumping data for table trippal.questions: ~1 rows (approximately)
...
INSERT INTO `users` (`id`, `role_id`, `parent_id`, `username`, `password`, `screen_name`, `email`, `phone`, `email_access_code`, `access_token`, `avatar`, `fbid`, `zalo`, `bank_code`, `bank_name`, `bank_master`, `bank`, `signature`, `is_active`, `ref_code`, `score_test`, `revenue`, `created`, `modified`) VALUES
	(1, 1, 0, 'admin', '$2y$10$Up8TGLboF/sj9eisGCWJE.SvnKMztBeyd4byZZR02UP8C7Mm5MEYW', 'Cường Bùi Việt', 'cuongbv90@gmail.com', '', '112421423423423423', 'EAAKx59Tq1vYBAA2nkz4nhx5tQ1qoPrqQAaBVt2eSSj2ISIEuIl0OJodiWk0iDLJwl3pxa7uIzeoBs1ARqZAZCokekxjJoZAgcVDtW7AEMnPoZBhCHOuZA1KVpyPZBCpiD8jtKJruicZCu7Ba7nA6quX4A0q7ZB3MQeycWhfL30RSBwZDZD', 'https://platform-lookaside.fbsbx.com/platform/profilepic/?asid=2096154020695275&height=800&width=800&ext=1545021818&hash=AeRWtkvw1LaxsS7R', '', '', '', '', '', '', '', 1, '', '0', 0, '2018-10-03 09:10:08', '2018-11-17 04:43:41'),
	(2, 2, 0, 'sale_admin', '$2y$10$k.ZxlyAKyqz2ufu.EV8yRO5Pv73QasCun/V9wV3c2FQ9rMSXpt81.', 'Sale Admin', 'zzphonixzz@gmail.com', '', 'mwhbzgcikbarqvgw', '', '', '', '', '', '', '', '', '<p>T&ecirc;n c&ocirc;ng ty: C&Ocirc;NG TY CỔ PHẦN DU LỊCH LI&Ecirc;N MINH VIỆT NAM<br />M&atilde; số thuế: 0108205732</p>\r\n<p>Địa chỉ xuất h&oacute;a đơn: Số 122 Trần Đại Nghĩa, P. Đồng T&acirc;m, Q. Hai B&agrave; Trưng, H&agrave; Nội</p>\r\n<p>Địa chỉ gửi thư: Số 71 Ch&ugrave;a L&aacute;ng, P. L&aacute;ng Thường, Q Đống Đa, H&agrave; Nội</p>\r\n<p>Người nhận: Ms. Quỳnh Anh, SĐT: 0869127716</p>\r\n<p><br />--------------------------------------------------------<br />NGUYỄN QUỲNH ANH | Sales &amp; Marketing | VIMI Travel</p>\r\n<p>Số 71 Ch&ugrave;a L&aacute;ng, P. L&aacute;ng Thượng, Q. Đống Đa, TP H&agrave; Nội</p>\r\n<p>DĐ: (+84) 0869127716| Email: sales2.vimitravel@gmail.com.</p>', 1, '', '0', 1904050, '2018-10-03 10:58:59', '2019-01-17 11:19:53'),
	(3, 3, 2, 'ctv', '$2y$10$k.ZxlyAKyqz2ufu.EV8yRO5Pv73QasCun/V9wV3c2FQ9rMSXpt81.', 'GonDaR', 'zzphonixzz@gmail.com', '12344567', 'sdfdsdfsdfsd', 'EAAKx59Tq1vYBAJ2WfxCY4zZC6DHKZBqw896aW9M3rZASAsSpZBXNHi8NxMONrnPhSiwhAoa2LIZBfZCEcOvWSNT7Od7ZBuv4AMnwgDm65vcdUG0GGSupaz6vR5qT9NZAzHdLKuuvjUTGq0QJK7kqjrX4Hkwi31FvRSQD5BfVfzbdws5nSB3JM3ri', 'https://platform-lookaside.fbsbx.com/platform/profilepic/?asid=2096154020695275&height=800&width=800&ext=1545021818&hash=AeRWtkvw1LaxsS7R', '1956545287747997', '0945554266', '234', 'không có', 'Bùi Hoàng Nam', 'chi nhánh gì gì đó', '', 1, 'TJ7P1I8Q7LTHIR057H2IILSA', '1/1', 460000, '2018-10-24 09:40:21', '2019-01-26 11:40:31'),
	(9, 3, 0, 'fb1956545287747997', '', 'Cường Bùi', 'gaproghe@gmail.com', '', '', 'EAAKx59Tq1vYBAMZCwUfuMPPpZAc0rvWEWovc1LbtwBEEhtwgVNhGRBZAKIOapjl9Yl3KeriEgscV0oKIacP3QxMY3ZCxeDmvWO9ZA2bZBcmiPrzMlVMeCP8vDCpb8hzutPNsIsFNZCR7PLhSkGnyyGaczCZAZBVviWvfkSjzLZBKvrU8xUZBqRDYBdljntdqXLOYGgZD', 'https://platform-lookaside.fbsbx.com/platform/profilepic/?asid=1956545287747997&height=800&width=800&ext=1546675183&hash=AeQKfYBS0csN4Age', 'https://facebook.com/profile.php?1956545287747997', '0973307590', '', '', '', '', '', 1, 'JSJI7FDPK5HAGCCXXAIQOBBX', '0', 0, '2018-11-17 09:22:49', '2018-12-06 14:59:46'),
	(10, 3, 2, 'ctv2', '$2y$10$cY4655fHly57187O4BhrTupP6Ts2hZw.lZPmjyFYmxnOwEYMnMwNa', 'CTV', 'ctv2@gmail.com', '', '', '', '', '', '', '', '', '', '', '', 1, 'P3W0K2Y9MZPVRRU2ADAEN7G3', '0', 0, '2018-11-27 18:18:14', '2018-11-27 18:18:14'),
	(11, 3, 2, 'ctv3', '$2y$10$mp8euBHD8iKJfbAoiYGvNuogW4YdL/qoGhmpGYNRC4YxR9u/JJ.dG', 'Cộng Tác viên 3', '923472823423', '', '', '', '', '', '', '', '', '', '', '', 1, '2f5yNpPOInL0KKDtnDD3zDv6', '0', 0, '2018-11-30 18:05:18', '2018-11-30 18:05:18'),
	(12, 3, 2, 'cuopkiabacon', '$2y$10$19QfxoC1mhhu7yEbpVAY5e1LyfzB1xBI4DemA8dQUpPpIMgWsqUgW', 'Gondar', 'cuongbv90@gmail.com', '0945554266', '', '', '', 'https://www.facebook.com/nam.buihoang.900', '0945554266', '', '', '', '', '', 1, 'j40ecjNFyBNadSzsvCeLjNnO', '0', 0, '2018-12-14 14:57:20', '2018-12-14 14:57:20'),
	(13, 3, 2, 'ctv1', '$2y$10$LTkcbfpgvGQHGhWP3lAFvuzfauQuR3IsC4XRknxDf.SMwxBst92.W', 'Gondar', 'ctv1@gmail.com', '0945554266', 'mwhbzgcikbarqvgw', '', '', 'https://www.facebook.com/nam.buihoang.900', '0945554266', '', '', '', '', '', 1, 'mKd4Fzp5xvsyrCzllwvLIjrG', '0', 0, '2019-01-08 09:39:11', '2019-01-08 09:39:11');
...
-- Dumping data for table trippal.user_sessions: ~20 rows (approximately)
/*!40000 ALTER TABLE `user_sessions` DISABLE KEYS */;
INSERT INTO `user_sessions` (`id`, `data`, `user_id`, `expires`, `created`) VALUES
	('0lvnt103m2avs4inkmtp6m0od4', 'Config|a:1:{s:4:"time";i:1548060673;}Auth|a:0:{}Flash|a:0:{}isShowPopupPromote|b:1;', NULL, 1548062115, '2019-01-21 15:47:47'),
	('1rr88m4a36eadscqkoocsen9j6', 'Config|a:1:{s:4:"time";i:1548298455;}isShowPopupPromote|b:1;', NULL, 1548299896, '2019-01-24 09:51:05'),
	('2jj9jj81dpagksfchgrieqgl00', 'Config|a:1:{s:4:"time";i:1548477636;}isShowPopupPromote|b:1;Auth|a:1:{s:4:"User";a:23:{s:2:"id";i:1;s:7:"role_id";i:1;s:9:"parent_id";i:0;s:8:"username";s:5:"admin";s:11:"screen_name";s:20:"Cường Bùi Việt";s:5:"email";s:19:"cuongbv90@gmail.com";s:5:"phone";s:0:"";s:17:"email_access_code";s:18:"112421423423423423";s:12:"access_token";s:179:"EAAKx59Tq1vYBAA2nkz4nhx5tQ1qoPrqQAaBVt2eSSj2ISIEuIl0OJodiWk0iDLJwl3pxa7uIzeoBs1ARqZAZCokekxjJoZAgcVDtW7AEMnPoZBhCHOuZA1KVpyPZBCpiD8jtKJruicZCu7Ba7nA6quX4A0q7ZB3MQeycWhfL30RSBwZDZD";s:6:"avatar";s:137:"https://platform-lookaside.fbsbx.com/platform/profilepic/?asid=2096154020695275&height=800&width=800&ext=1545021818&hash=AeRWtkvw1LaxsS7R";s:4:"fbid";s:0:"";s:4:"zalo";s:0:"";s:9:"bank_code";s:0:"";s:9:"bank_name";s:0:"";s:11:"bank_master";s:0:"";s:4:"bank";s:0:"";s:9:"signature";s:0:"";s:9:"is_active";i:1;s:8:"ref_code";s:0:"";s:10:"score_test";s:1:"0";s:7:"revenue";i:0;s:7:"created";O:20:"Cake\\I18n\\FrozenTime":3:{s:4:"date";s:26:"2018-10-03 09:10:08.000000";s:13:"timezone_type";i:3;s:8:"timezone";s:16:"Asia/Ho_Chi_Minh";}s:8:"modified";O:20:"Cake\\I18n\\FrozenTime":3:{s:4:"date";s:26:"2018-11-17 04:43:41.000000";s:13:"timezone_type";i:3;s:8:"timezone";s:16:"Asia/Ho_Chi_Minh";}}}Flash|a:0:{}', 1, 1548479076, '2019-01-26 10:41:08'),
	('3f7tssc3bhcdvdh9os4r5op2t5', 'Config|a:1:{s:4:"time";i:1547698843;}isShowPopupPromote|b:1;Auth|a:1:{s:4:"User";a:22:{s:2:"id";i:1;s:7:"role_id";i:1;s:9:"parent_id";i:0;s:8:"username";s:5:"admin";s:11:"screen_name";s:20:"Cường Bùi Việt";s:5:"email";s:19:"cuongbv90@gmail.com";s:5:"phone";s:0:"";s:17:"email_access_code";s:18:"112421423423423423";s:12:"access_token";s:179:"EAAKx59Tq1vYBAA2nkz4nhx5tQ1qoPrqQAaBVt2eSSj2ISIEuIl0OJodiWk0iDLJwl3pxa7uIzeoBs1ARqZAZCokekxjJoZAgcVDtW7AEMnPoZBhCHOuZA1KVpyPZBCpiD8jtKJruicZCu7Ba7nA6quX4A0q7ZB3MQeycWhfL30RSBwZDZD";s:6:"avatar";s:137:"https://platform-lookaside.fbsbx.com/platform/profilepic/?asid=2096154020695275&height=800&width=800&ext=1545021818&hash=AeRWtkvw1LaxsS7R";s:4:"fbid";s:0:"";s:4:"zalo";s:0:"";s:9:"bank_code";s:0:"";s:9:"bank_name";s:0:"";s:11:"bank_master";s:0:"";s:4:"bank";s:0:"";s:9:"signature";s:0:"";s:9:"is_active";i:1;s:8:"ref_code";s:0:"";s:7:"revenue";i:0;s:7:"created";O:20:"Cake\\I18n\\FrozenTime":3:{s:4:"date";s:26:"2018-10-03 09:10:08.000000";s:13:"timezone_type";i:3;s:8:"timezone";s:16:"Asia/Ho_Chi_Minh";}s:8:"modified";O:20:"Cake\\I18n\\FrozenTime":3:{s:4:"date";s:26:"2018-11-17 04:43:41.000000";s:13:"timezone_type";i:3;s:8:"timezone";s:16:"Asia/Ho_Chi_Minh";}}}Flash|a:0:{}', 1, 1547700283, '2019-01-17 10:09:08'),
	('7feskfbdahfg7l0brt3jvtfml0', 'Config|a:1:{s:4:"time";i:1547802290;}Auth|a:1:{s:4:"User";a:22:{s:2:"id";i:2;s:7:"role_id";i:2;s:9:"parent_id";i:0;s:8:"username";s:10:"sale_admin";s:11:"screen_name";s:10:"Sale Admin";s:5:"email";s:20:"zzphonixzz@gmail.com";s:5:"phone";s:0:"";s:17:"email_access_code";s:16:"mwhbzgcikbarqvgw";s:12:"access_token";s:0:"";s:6:"avatar";s:0:"";s:4:"fbid";s:0:"";s:4:"zalo";s:0:"";s:9:"bank_code";s:0:"";s:9:"bank_name";s:0:"";s:11:"bank_master";s:0:"";s:4:"bank";s:0:"";s:9:"signature";s:759:"<p>T&ecirc;n c&ocirc;ng ty: C&Ocirc;NG TY CỔ PHẦN DU LỊCH LI&Ecirc;N MINH VIỆT NAM<br />M&atilde; số thuế: 0108205732</p>\r\n<p>Địa chỉ xuất h&oacute;a đơn: Số 122 Trần Đại Nghĩa, P. Đồng T&acirc;m, Q. Hai B&agrave; Trưng, H&agrave; Nội</p>\r\n<p>Địa chỉ gửi thư: Số 71 Ch&ugrave;a L&aacute;ng, P. L&aacute;ng Thường, Q Đống Đa, H&agrave; Nội</p>\r\n<p>Người nhận: Ms. Quỳnh Anh, SĐT: 0869127716</p>\r\n<p><br />--------------------------------------------------------<br />NGUYỄN QUỲNH ANH | Sales &amp; Marketing | VIMI Travel</p>\r\n<p>Số 71 Ch&ugrave;a L&aacute;ng, P. L&aacute;ng Thượng, Q. Đống Đa, TP H&agrave; Nội</p>\r\n<p>DĐ: (+84) 0869127716| Email: sales2.vimitravel@gmail.com.</p>";s:9:"is_active";i:1;s:8:"ref_code";s:0:"";s:7:"revenue";i:1904050;s:7:"created";O:20:"Cake\\I18n\\FrozenTime":3:{s:4:"date";s:26:"2018-10-03 10:58:59.000000";s:13:"timezone_type";i:3;s:8:"timezone";s:16:"Asia/Ho_Chi_Minh";}s:8:"modified";O:20:"Cake\\I18n\\FrozenTime":3:{s:4:"date";s:26:"2019-01-17 11:19:53.000000";s:13:"timezone_type";i:3;s:8:"timezone";s:16:"Asia/Ho_Chi_Minh";}}}Flash|a:0:{}isShowPopupPromote|b:1;', 2, 1547803731, '2019-01-18 14:49:25'),
	('a5trqaao4svo4fcl7b2hp2uvc7', 'Config|a:1:{s:4:"time";i:1547638148;}isShowPopupPromote|b:1;Auth|a:1:{s:4:"User";a:20:{s:2:"id";i:3;s:7:"role_id";i:3;s:9:"parent_id";i:2;s:8:"username";s:3:"ctv";s:11:"screen_name";s:6:"GonDaR";s:5:"email";s:20:"zzphonixzz@gmail.com";s:5:"phone";s:8:"12344567";s:17:"email_access_code";s:12:"sdfdsdfsdfsd";s:12:"access_token";s:185:"EAAKx59Tq1vYBAJ2WfxCY4zZC6DHKZBqw896aW9M3rZASAsSpZBXNHi8NxMONrnPhSiwhAoa2LIZBfZCEcOvWSNT7Od7ZBuv4AMnwgDm65vcdUG0GGSupaz6vR5qT9NZAzHdLKuuvjUTGq0QJK7kqjrX4Hkwi31FvRSQD5BfVfzbdws5nSB3JM3ri";s:6:"avatar";s:137:"https://platform-lookaside.fbsbx.com/platform/profilepic/?asid=2096154020695275&height=800&width=800&ext=1545021818&hash=AeRWtkvw1LaxsS7R";s:4:"fbid";s:16:"1956545287747997";s:4:"zalo";s:10:"0945554266";s:9:"bank_code";s:0:"";s:4:"bank";s:0:"";s:9:"signature";s:0:"";s:9:"is_active";i:1;s:8:"ref_code";s:24:"TJ7P1I8Q7LTHIR057H2IILSA";s:7:"revenue";i:680000;s:7:"created";O:20:"Cake\\I18n\\FrozenTime":3:{s:4:"date";s:26:"2018-10-24 09:40:21.000000";s:13:"timezone_type";i:3;s:8:"timezone";s:16:"Asia/Ho_Chi_Minh";}s:8:"modified";O:20:"Cake\\I18n\\FrozenTime":3:{s:4:"date";s:26:"2019-01-16 17:39:27.000000";s:13:"timezone_type";i:3;s:8:"timezone";s:16:"Asia/Ho_Chi_Minh";}}}', 3, 1547639589, '2019-01-16 17:52:34'),
	('apm4a57t3l911u4s4fp5l75hg6', 'Config|a:1:{s:4:"time";i:1548404836;}isShowPopupPromote|b:1;', NULL, 1548406279, '2019-01-25 15:25:53'),
	('at1loqfjsimnkcgvadr16dvt00', 'Config|a:1:{s:4:"time";i:1548402439;}isShowPopupPromote|b:1;', NULL, 1548403880, '2019-01-25 14:47:05'),
	...
	('ejh0vdka9v0e2qa25n4k2f1ok4', 'Config|a:1:{s:4:"time";i:1547895576;}Auth|a:1:{s:4:"User";a:22:{s:2:"id";i:1;s:7:"role_id";i:1;s:9:"parent_id";i:0;s:8:"username";s:5:"admin";s:11:"screen_name";s:20:"Cường Bùi Việt";s:5:"email";s:19:"cuongbv90@gmail.com";s:5:"phone";s:0:"";s:17:"email_access_code";s:18:"112421423423423423";s:12:"access_token";s:179:"EAAKx59Tq1vYBAA2nkz4nhx5tQ1qoPrqQAaBVt2eSSj2ISIEuIl0OJodiWk0iDLJwl3pxa7uIzeoBs1ARqZAZCokekxjJoZAgcVDtW7AEMnPoZBhCHOuZA1KVpyPZBCpiD8jtKJruicZCu7Ba7nA6quX4A0q7ZB3MQeycWhfL30RSBwZDZD";s:6:"avatar";s:137:"https://platform-lookaside.fbsbx.com/platform/profilepic/?asid=2096154020695275&height=800&width=800&ext=1545021818&hash=AeRWtkvw1LaxsS7R";s:4:"fbid";s:0:"";s:4:"zalo";s:0:"";s:9:"bank_code";s:0:"";s:9:"bank_name";s:0:"";s:11:"bank_master";s:0:"";s:4:"bank";s:0:"";s:9:"signature";s:0:"";s:9:"is_active";i:1;s:8:"ref_code";s:0:"";s:7:"revenue";i:0;s:7:"created";O:20:"Cake\\I18n\\FrozenTime":3:{s:4:"date";s:26:"2018-10-03 09:10:08.000000";s:13:"timezone_type";i:3;s:8:"timezone";s:16:"Asia/Ho_Chi_Minh";}s:8:"modified";O:20:"Cake\\I18n\\FrozenTime":3:{s:4:"date";s:26:"2018-11-17 04:43:41.000000";s:13:"timezone_type";i:3;s:8:"timezone";s:16:"Asia/Ho_Chi_Minh";}}}Flash|a:0:{}', 1, 1547897019, '2019-01-19 17:39:11'),
	('g1ud9m325j2sbsqggp68dmjb93', 'Config|a:1:{s:4:"time";i:1549965740;}isShowPopupPromote|b:1;', NULL, 1549967181, '2019-02-12 17:02:14'),
	('hb58om67i5k5g1605djdsk78e6', 'Config|a:1:{s:4:"time";i:1547638296;}', NULL, 1547639736, '2019-01-16 18:31:34'),
	('hhmskrga3ul922fd6b6b09uq87', 'Config|a:1:{s:4:"time";i:1548471088;}isShowPopupPromote|b:1;Auth|a:1:{s:4:"User";a:23:{s:2:"id";i:3;s:7:"role_id";i:3;s:9:"parent_id";i:2;s:8:"username";s:3:"ctv";s:11:"screen_name";s:6:"GonDaR";s:5:"email";s:20:"zzphonixzz@gmail.com";s:5:"phone";s:8:"12344567";s:17:"email_access_code";s:12:"sdfdsdfsdfsd";s:12:"access_token";s:185:"EAAKx59Tq1vYBAJ2WfxCY4zZC6DHKZBqw896aW9M3rZASAsSpZBXNHi8NxMONrnPhSiwhAoa2LIZBfZCEcOvWSNT7Od7ZBuv4AMnwgDm65vcdUG0GGSupaz6vR5qT9NZAzHdLKuuvjUTGq0QJK7kqjrX4Hkwi31FvRSQD5BfVfzbdws5nSB3JM3ri";s:6:"avatar";s:137:"https://platform-lookaside.fbsbx.com/platform/profilepic/?asid=2096154020695275&height=800&width=800&ext=1545021818&hash=AeRWtkvw1LaxsS7R";s:4:"fbid";s:16:"1956545287747997";s:4:"zalo";s:10:"0945554266";s:9:"bank_code";s:3:"234";s:9:"bank_name";s:10:"không có";s:11:"bank_master";s:15:"Bùi Hoàng Nam";s:4:"bank";s:23:"chi nhánh gì gì đó";s:9:"signature";s:0:"";s:9:"is_active";i:1;s:8:"ref_code";s:24:"TJ7P1I8Q7LTHIR057H2IILSA";s:10:"score_test";s:1:"0";s:7:"revenue";i:460000;s:7:"created";O:20:"Cake\\I18n\\FrozenTime":3:{s:4:"date";s:26:"2018-10-24 09:40:21.000000";s:13:"timezone_type";i:3;s:8:"timezone";s:16:"Asia/Ho_Chi_Minh";}s:8:"modified";O:20:"Cake\\I18n\\FrozenTime":3:{s:4:"date";s:26:"2019-01-17 14:18:43.000000";s:13:"timezone_type";i:3;s:8:"timezone";s:16:"Asia/Ho_Chi_Minh";}}}', 3, 1548472537, '2019-01-26 09:47:26'),
	('irh4jm64a3mh13esq4dskum0p2', 'Config|a:1:{s:4:"time";i:1548318365;}Auth|a:1:{s:4:"User";a:22:{s:2:"id";i:2;s:7:"role_id";i:2;s:9:"parent_id";i:0;s:8:"username";s:10:"sale_admin";s:11:"screen_name";s:10:"Sale Admin";s:5:"email";s:20:"zzphonixzz@gmail.com";s:5:"phone";s:0:"";s:17:"email_access_code";s:16:"mwhbzgcikbarqvgw";s:12:"access_token";s:0:"";s:6:"avatar";s:0:"";s:4:"fbid";s:0:"";s:4:"zalo";s:0:"";s:9:"bank_code";s:0:"";s:9:"bank_name";s:0:"";s:11:"bank_master";s:0:"";s:4:"bank";s:0:"";s:9:"signature";s:759:"<p>T&ecirc;n c&ocirc;ng ty: C&Ocirc;NG TY CỔ PHẦN DU LỊCH LI&Ecirc;N MINH VIỆT NAM<br />M&atilde; số thuế: 0108205732</p>\r\n<p>Địa chỉ xuất h&oacute;a đơn: Số 122 Trần Đại Nghĩa, P. Đồng T&acirc;m, Q. Hai B&agrave; Trưng, H&agrave; Nội</p>\r\n<p>Địa chỉ gửi thư: Số 71 Ch&ugrave;a L&aacute;ng, P. L&aacute;ng Thường, Q Đống Đa, H&agrave; Nội</p>\r\n<p>Người nhận: Ms. Quỳnh Anh, SĐT: 0869127716</p>\r\n<p><br />--------------------------------------------------------<br />NGUYỄN QUỲNH ANH | Sales &amp; Marketing | VIMI Travel</p>\r\n<p>Số 71 Ch&ugrave;a L&aacute;ng, P. L&aacute;ng Thượng, Q. Đống Đa, TP H&agrave; Nội</p>\r\n<p>DĐ: (+84) 0869127716| Email: sales2.vimitravel@gmail.com.</p>";s:9:"is_active";i:1;s:8:"ref_code";s:0:"";s:7:"revenue";i:1904050;s:7:"created";O:20:"Cake\\I18n\\FrozenTime":3:{s:4:"date";s:26:"2018-10-03 10:58:59.000000";s:13:"timezone_type";i:3;s:8:"timezone";s:16:"Asia/Ho_Chi_Minh";}s:8:"modified";O:20:"Cake\\I18n\\FrozenTime":3:{s:4:"date";s:26:"2019-01-17 11:19:53.000000";s:13:"timezone_type";i:3;s:8:"timezone";s:16:"Asia/Ho_Chi_Minh";}}}', 2, 1548319805, '2019-01-24 15:00:56'),
	...
	('r3f9rphie7oglhfu0gide8emg1', 'Config|a:1:{s:4:"time";i:1547700642;}', NULL, 1547702083, '2019-01-17 11:50:11'),
	('s0v6jfg41hohkfot8oo0c6j095', 'Config|a:1:{s:4:"time";i:1548648567;}isShowPopupPromote|b:1;Auth|a:1:{s:4:"User";a:23:{s:2:"id";i:1;s:7:"role_id";i:1;s:9:"parent_id";i:0;s:8:"username";s:5:"admin";s:11:"screen_name";s:20:"Cường Bùi Việt";s:5:"email";s:19:"cuongbv90@gmail.com";s:5:"phone";s:0:"";s:17:"email_access_code";s:18:"112421423423423423";s:12:"access_token";s:179:"EAAKx59Tq1vYBAA2nkz4nhx5tQ1qoPrqQAaBVt2eSSj2ISIEuIl0OJodiWk0iDLJwl3pxa7uIzeoBs1ARqZAZCokekxjJoZAgcVDtW7AEMnPoZBhCHOuZA1KVpyPZBCpiD8jtKJruicZCu7Ba7nA6quX4A0q7ZB3MQeycWhfL30RSBwZDZD";s:6:"avatar";s:137:"https://platform-lookaside.fbsbx.com/platform/profilepic/?asid=2096154020695275&height=800&width=800&ext=1545021818&hash=AeRWtkvw1LaxsS7R";s:4:"fbid";s:0:"";s:4:"zalo";s:0:"";s:9:"bank_code";s:0:"";s:9:"bank_name";s:0:"";s:11:"bank_master";s:0:"";s:4:"bank";s:0:"";s:9:"signature";s:0:"";s:9:"is_active";i:1;s:8:"ref_code";s:0:"";s:10:"score_test";s:1:"0";s:7:"revenue";i:0;s:7:"created";O:20:"Cake\\I18n\\FrozenTime":3:{s:4:"date";s:26:"2018-10-03 09:10:08.000000";s:13:"timezone_type";i:3;s:8:"timezone";s:16:"Asia/Ho_Chi_Minh";}s:8:"modified";O:20:"Cake\\I18n\\FrozenTime":3:{s:4:"date";s:26:"2018-11-17 04:43:41.000000";s:13:"timezone_type";i:3;s:8:"timezone";s:16:"Asia/Ho_Chi_Minh";}}}Flash|a:0:{}', 1, 1548650008, '2019-01-28 10:56:13'),
	('svr5aoqjkmarnllq83v1f869f3', 'Config|a:1:{s:4:"time";i:1549090638;}isShowPopupPromote|b:1;Auth|a:1:{s:4:"User";a:23:{s:2:"id";i:1;s:7:"role_id";i:1;s:9:"parent_id";i:0;s:8:"username";s:5:"admin";s:11:"screen_name";s:20:"Cường Bùi Việt";s:5:"email";s:19:"cuongbv90@gmail.com";s:5:"phone";s:0:"";s:17:"email_access_code";s:18:"112421423423423423";s:12:"access_token";s:179:"EAAKx59Tq1vYBAA2nkz4nhx5tQ1qoPrqQAaBVt2eSSj2ISIEuIl0OJodiWk0iDLJwl3pxa7uIzeoBs1ARqZAZCokekxjJoZAgcVDtW7AEMnPoZBhCHOuZA1KVpyPZBCpiD8jtKJruicZCu7Ba7nA6quX4A0q7ZB3MQeycWhfL30RSBwZDZD";s:6:"avatar";s:137:"https://platform-lookaside.fbsbx.com/platform/profilepic/?asid=2096154020695275&height=800&width=800&ext=1545021818&hash=AeRWtkvw1LaxsS7R";s:4:"fbid";s:0:"";s:4:"zalo";s:0:"";s:9:"bank_code";s:0:"";s:9:"bank_name";s:0:"";s:11:"bank_master";s:0:"";s:4:"bank";s:0:"";s:9:"signature";s:0:"";s:9:"is_active";i:1;s:8:"ref_code";s:0:"";s:10:"score_test";s:1:"0";s:7:"revenue";i:0;s:7:"created";O:20:"Cake\\I18n\\FrozenTime":3:{s:4:"date";s:26:"2018-10-03 09:10:08.000000";s:13:"timezone_type";i:3;s:8:"timezone";s:16:"Asia/Ho_Chi_Minh";}s:8:"modified";O:20:"Cake\\I18n\\FrozenTime":3:{s:4:"date";s:26:"2018-11-17 04:43:41.000000";s:13:"timezone_type";i:3;s:8:"timezone";s:16:"Asia/Ho_Chi_Minh";}}}Flash|a:0:{}', 1, 1549092078, '2019-02-02 13:35:24'),
	('tslstndofoc2nu8c9i8nje7g32', 'Config|a:1:{s:4:"time";i:1547711495;}Auth|a:1:{s:4:"User";a:22:{s:2:"id";i:1;s:7:"role_id";i:1;s:9:"parent_id";i:0;s:8:"username";s:5:"admin";s:11:"screen_name";s:20:"Cường Bùi Việt";s:5:"email";s:19:"cuongbv90@gmail.com";s:5:"phone";s:0:"";s:17:"email_access_code";s:18:"112421423423423423";s:12:"access_token";s:179:"EAAKx59Tq1vYBAA2nkz4nhx5tQ1qoPrqQAaBVt2eSSj2ISIEuIl0OJodiWk0iDLJwl3pxa7uIzeoBs1ARqZAZCokekxjJoZAgcVDtW7AEMnPoZBhCHOuZA1KVpyPZBCpiD8jtKJruicZCu7Ba7nA6quX4A0q7ZB3MQeycWhfL30RSBwZDZD";s:6:"avatar";s:137:"https://platform-lookaside.fbsbx.com/platform/profilepic/?asid=2096154020695275&height=800&width=800&ext=1545021818&hash=AeRWtkvw1LaxsS7R";s:4:"fbid";s:0:"";s:4:"zalo";s:0:"";s:9:"bank_code";s:0:"";s:9:"bank_name";s:0:"";s:11:"bank_master";s:0:"";s:4:"bank";s:0:"";s:9:"signature";s:0:"";s:9:"is_active";i:1;s:8:"ref_code";s:0:"";s:7:"revenue";i:0;s:7:"created";O:20:"Cake\\I18n\\FrozenTime":3:{s:4:"date";s:26:"2018-10-03 09:10:08.000000";s:13:"timezone_type";i:3;s:8:"timezone";s:16:"Asia/Ho_Chi_Minh";}s:8:"modified";O:20:"Cake\\I18n\\FrozenTime":3:{s:4:"date";s:26:"2018-11-17 04:43:41.000000";s:13:"timezone_type";i:3;s:8:"timezone";s:16:"Asia/Ho_Chi_Minh";}}}', 1, 1547712937, '2019-01-17 14:51:26'),
	('utg3pt3n1bhvd4i9fcqi915ga7', 'Config|a:1:{s:4:"time";i:1547722466;}isShowPopupPromote|b:1;Auth|a:0:{}', NULL, 1547723907, '2019-01-17 17:38:16');
...
-- Dumping data for table trippal.user_shares: ~0 rows (approximately)
...
-- Dumping data for table trippal.user_transactions: ~0 rows (approximately)
...
-- Dumping data for table trippal.vouchers: ~7 rows (approximately)
...
INSERT INTO `vouchers` (`id`, `user_id`, `hotel_id`, `name`, `slug`, `caption`, `description`, `price`, `trippal_price`, `customer_price`, `promote`, `departure_id`, `destination_id`, `days_attended`, `rating`, `thumbnail`, `media`, `fb_content`, `icon_list`, `start_date`, `end_date`, `status`, `term`, `is_featured`, `created`, `modified`) VALUES
	...
	(2, 1, 3, 'voucher đi chơi', 'voucher-di-choi', '[{"icon":"fas fa-plane","content":"ngắn vãi lòn"},{"icon":"far fa-clock","content":"213"}]', '<p>nội dung combo</p>', 0, 130, 150, 10, 5, 5, 3, 5, 'files/uploads/1544414216-Pikachu-Running-Picture.png', '["files/uploads/1544414189-617241-Books-1381638164-211-640x480.JPG","files/uploads/1544414189-44755781_1564412763704990_3773877274961510400_n.jpg","files/uploads/1544414189-44838467_732108043834302_1815030690840838144_n.jpg"]', '', '[]', '2018-12-31', '2019-01-02', 0, '', 0, '2018-12-10 10:56:56', '2019-02-02 13:57:09'),
	...
	(8, 2, 1, '123', '123', '[{"icon":"far fa-clock","content":"123"}]', '<p>1123</p>', 0, 130, 150, 5, 5, 6, 3, 5, 'files/uploads/1547797879-48417226_1958541020849323_9173472707377889280_n.jpg', '', 'ád', '["fas fa-plane"]', '2019-01-01', '2019-12-31', 0, '', 0, '2019-01-18 14:51:19', '2019-01-18 14:51:19'),
	(9, 1, 3, 'voucher test term', 'voucher-test-term', '[{"icon":"fas fa-check","content":"máy bay"}]', '<p>123</p>', 120, 130, 150, 10, 4, 4, 3, 5, 'files/uploads/1547895573-Pikachu-Running-Picture.png', '', '123', '["fas fa-glass-martini"]', '2019-01-16', '2019-02-16', 0, '<p>132</p>', 0, '2019-01-19 17:59:33', '2019-01-19 17:59:33'),
	(10, 2, 1, '123123', '123123', '[{"icon":"fas fa-check","content":"123"}]', '<p>123</p>', 0, 130, 150, 12, 5, 5, 3, 5, 'files/uploads/1548060272-Pikachu-Running-Picture.png', '["files/uploads/1548060253-44755781_1564412763704990_3773877274961510400_n.jpg"]', '123', '["fas fa-check"]', '2019-01-21', '2019-01-21', 0, '<p>123</p>', 0, '2019-01-21 15:44:33', '2019-01-21 15:44:33');
...
-- Dumping data for table trippal.withdraws: ~1 rows (approximately)
/*!40000 ALTER TABLE `withdraws` DISABLE KEYS */;
INSERT INTO `withdraws` (`id`, `user_id`, `amount`, `status`, `created`, `modified`) VALUES
	(1, 3, 200000, 1, '2019-01-17 07:18:43', '2019-01-17 14:18:43');
