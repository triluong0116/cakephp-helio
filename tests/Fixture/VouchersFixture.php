...
class VouchersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'caption' => ['type' => 'text', 'length' => null, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'end_date' => '2018-10-18',
                'status' => 1,
                'created' => '2018-10-18 09:29:13',
                'modified' => '2018-10-18 09:29:13'
            ],
        ];
        parent::init();
    }
