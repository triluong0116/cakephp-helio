 ...
 *
 */
class BookingLogsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'comment' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => '', 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'type' => 1,
                'status' => 1,
                'created' => '2022-08-23 16:58:04',
                'modified' => '2022-08-23 16:58:04'
            ],
        ];
        parent::init();
    }
