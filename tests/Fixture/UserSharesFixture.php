 ...
 *
 */
class UserSharesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'object_type' => ['type' => 'integer', 'length' => 2, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'object_id' => 1,
                'object_type' => 1,
                'created' => '2018-12-05 11:26:58',
                'modified' => '2018-12-05 11:26:58'
            ],
        ];
        parent::init();
    }
