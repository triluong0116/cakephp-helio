...
return [
     ...
     */
    'Security' => [
        'salt' => env('SECURITY_SALT', 'sDsMF9FuauTQ75kqTbcKRkjryDp4gjJZUhAKXZfsFXHFccHUuFa4nzA29zbLGuZg'),
    ],
    /**
    ...
    'EmailTransport' => [
        ...
        'gmail_noti_user' => [
            ...
            'port' => 465,
            'username' => 'helitechtestmail@gmail.com',
            'password' => 'iezyjouvlragcoig',
            'className' => 'Smtp',
            'log' => true,
            'context' => [
                'ssl' => [
    ...
    'Email' => [
        ...
        'gmail' => [
            'host' => 'ssl://smtp.gmail.com',
            'port' => 465,
            'username' => 'socialmin30@gmail.com',
            'password' => '12345689iop',
            'className' => 'Smtp',
            'log' => true,
            'context' => [
                'ssl' => [
